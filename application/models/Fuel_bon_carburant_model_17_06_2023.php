...
/**/
		$requete="";
		$requete="bc_vehicule_id=v_id AND bc_carte_id=cc_id AND bc_date BETWEEN '$from' AND '$to'";
		
				if($vehicle=='all') {
					$requete="bc_vehicule_id=v_id AND bc_carte_id=cc_id AND bc_date BETWEEN '$from' AND '$to'";
				} else {
					$requete="bc_vehicule_id=v_id AND bc_carte_id=cc_id AND bc_vehicule_id='$vehicle' AND bc_date BETWEEN '$from' AND '$to'";
				}
