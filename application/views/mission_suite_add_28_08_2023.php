    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-9">
            <h1 class="m-0 text-dark">Gestion des suites des missions : <?php echo $missionsuite[0]['mi_numero'];?> </h1>
          </div><!-- /.col -->
          <div class="col-sm-3">
...
<!--BEGIN LIST-->                      
<form method="post" id="mission" class="card" action="<?php echo base_url();?>mission/<?php echo (isset($missiondetails))?'updatemission_suite':'insertmission_suite'; ?>">
          <div class="card-body">
...
<div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         ...
                         <input type="text" class="form-control" id="mi_date_mission" name="mi_date_mission" value="<?php echo $missionsuite[0]['mi_date_mission'];?>"  readonly>
	...
	<div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label"> Pregate<span class="form-required">*</span></label>
					  ...
					  <input required type="text" name="mi_trip_id1" id="mi_trip_id1"  value="<?php //echo $missionsuite[0]['pregate']->pr_numero;?><?= (isset($missionsuite[0]['pregate']->pr_numero))?$missionsuite[0]['pregate']->pr_numero:'Non renseigné'; ?>" class="form-control" readonly >			 					  
                  </div>
               </div>					  
...
<input required type="text" name="mi_conteneur_id1" id="mi_conteneur_id1"  value="<?= (isset($missionsuite[0]['mi_conteneur_id']))?join_multi_select($missionsuite[0]['mi_conteneur_id'], 'trip_conteneur', 'co_id', 'co_numero_conteneur'):'Non renseigné'; ?>" class="form-control" readonly>					  
...
<div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label"> Type de mission<span class="form-required">*</span></label>
					  
<input required type="text" name="mi_type_mission1" id="mi_type_mission1"  value="<?php echo $missionsuite[0]['mi_type_mission'];?>" class="form-control" readonly>					  
...
<div class="col-sm-6 col-md-3">
                      <div class="form-group">
                          <label class="form-label">Date mission<span class="form-required">*</span></label>
                         <input type="text" class="form-control datepicker" id="mi_mission_date" name="mi_mission_date" value="<?php echo (isset($missiondetails)) ? $missiondetails[0]['mi_mission_date']:'' ?>" placeholder="<?php echo date('Y-m-d'); ?>" required>
...
<div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <select id="mi_lieu_livraison" name="mi_lieu_livraison"  class="form-control input-lg" >						 
...
<!-- FIN-->					  
		...
		<div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <select id="mi_vehicle_id_mise_terre" class="form-control selectized" name="mi_vehicle_id" required>
...
<!-- Fin Carte Carburant-->                    
   ...
   <!-- FIN MISSION-->
 	...
 	<div id="mi_bon_carburant_mise_terre">
	</div>	     
                </div>
...
<input type="hidden" id="mi_created_date" name="mi_created_date" value="<?php echo date('Y-m-d h:i:s'); ?>">
                  ...
                  <!--<input type="hidden" id="mi_type_mission" name="mi_type_mission" value="MISE_A_TERRE">-->
<input type="text" id="mi_mission_id" name="mi_mission_id" value="<?php echo $this->uri->segment(3)?>">
<input required type="hidden" name="mi_trip_id" id="mi_trip_id"  value="<?php echo $missionsuite[0]['mi_trip_id'];?>" class="form-control"  >
<input required type="hidden" name="mi_numero" id="mi_numero"  value="<?php echo $missionsuite[0]['mi_numero'];?>" class="form-control"  >
			  
<!--<input  type="hidden" name="mi_type_mission" id="mi_type_mission"  value="<?php //echo $missionsuite[0]['mi_type_mission'];?>" class="form-control" >	-->
<input required type="hidden" name="mi_conteneur_id[]" id="mi_conteneur_id"  value="<?php echo $missionsuite[0]['mi_conteneur_id']; ?>" class="form-control" >				  
 <?php } ?>
