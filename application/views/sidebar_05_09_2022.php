...
<!--Fin comptabilité-->		
            ...
            <li class="nav-item has-treeview <?php echo ((activate_menu('addmission'))=='active') ? 'menu-open':'' ?>
               <?php echo ((activate_menu('addmission'))=='active') ? 'menu-open':'' ?><?php echo ((activate_menu('editmission'))=='active') ? 'menu-open':'' ?> <?php echo ((activate_menu('pregate'))=='active') ? 'menu-open':'' ?>
...
<!---->                  <li class="nav-item">
                     <a href="<?= base_url(); ?>eir_plein/addeir_plein" class="nav-link <?php echo activate_menu('eir_plein');?>">
                        <i class="nav-icon fas faa-plus"></i>
                        <p>Gestion des EIR PLEINS</p>
                     </a>
                  </li>
                  <?php //} ?>
...
<!--                  <li class="nav-item">
			 ...
			 if(userpermission('lr_fuel_add')) { ?>
                ...
                <?php  if(userpermission('lr_fuel_list')) { ?>
                  <li class="nav-item">
                     <a href="<?= base_url(); ?>fuel_bon_carburant" class="nav-link <?php echo activate_menu('fuel_bon_carburant');?> <?php echo activate_menu('editfuel_bon_carburant');?>">
                        <i class="nav-icon fas faa-list"></i>
                        <p>Gestion des bon carburant</p>
                     </a>
                  </li>
