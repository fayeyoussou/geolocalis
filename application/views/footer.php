<footer class="main-footer">
   <strong>Conception By <a href="http://sysweg.com" target="_blank">Sysweg - +221 77 663 20 20</a>.</strong>
...
<link rel="<?= base_url(); ?>assets/plugins/daterangepicker/daterangepicker.css">
...
<?php 
  // if($seg=='booking' || $seg=='incomeexpense' || $seg=='fuels' || $seg=='incomexpense') {
   ?>
...
<?php //} 
   if($seg=='addgeofence' || $seg=='addfacture'  || $seg=='addtrips' || $seg=='geofence' || $seg == 'livestatus' || $seg == 'tracking') {
      $data = sitedata();
    ?>
...
<?php 
   if($seg=='addgeofence' || $seg=='addmission' || $seg=='editmission' || $seg=='addristourne' || $seg=='editristourne' || $seg=='addfuel_bon_carburant' || $seg=='editfuel_bon_carburant') { ?>
