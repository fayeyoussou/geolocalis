...
/**/$tbl = '<table width="350"  >
    ...
    <tr>
        ...
        <td width="130"><b></b>MONTANT</td>
        <td width="10">:</td>
        <td width="150">'.$incomexpensedetails['ie_amount'].'</td>
    </tr>
</table>';
...
$html = '<table border="0" cellspacing="0" align="center" width="100%" > 
        <tr height="20" style="color:#000;border:1px solid #000;">
            ...
            <th width="15%"><h5>FACTURE</h5></th>
            <th width="20%"><h5>TRANSITAIRE</h5></th>
            <th width="20%"><h5>CLIENT</h5></th>
            <th width="15%"><h5>MONTANT FACTURE</h5></th>
 ...
 $tra_name = $paiementreglementdetails['transitaire']->tra_name;		
         ...
         else
         {
              ...
              $html .=  '
                    ...
                    <td width="15%">'.$t_num_facture.'</td>
                    <td width="20%">'.$tra_name.'</td>
                    <td width="20%">'.$c_name.'</td>
                    <td width="15%">'.$t_trip_amount.'</td>
                    <td width="10%">'.$paiementreglementdetails['tp_type'].'</td>
                    <td width="10%">'.$paiementreglementdetails['tp_amount'].'</td>
                    </tr>';
