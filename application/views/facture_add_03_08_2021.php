    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?php echo (isset($facturedetails))?'Modifier facture':'Ajouter facture' ?><?php if((isset($facturedetails))){ ?>    N°  <?php echo (isset($facturedetails)) ? $facturedetails[0]['t_num_facture']:'' ?>  <?php }?> N°
                FA00<?= $numerofacture; ?> 
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                ...
                <div class="col-sm-6 col-md-3">
                 <div class="form-group">
                     ...
                     <select name="t_taxe" id="t_taxe" required="true" class="form-control">
                      ...
                      <option <?php if((isset($facturedetails)) && $facturedetails[0]['t_taxe'] =='avec_tva'){ echo 'selected';} ?> value="avec_tva">Entreprise</option>

                      <option <?php if((isset($facturedetails)) && $facturedetails[0]['t_taxe'] =='sans_tva'){ echo 'selected';} ?> value="sans_tva">Particulier</option>						 
                    </select>
                  </div>
                </div>                
...
<!-- debut Nature-->
            ...
            <input type="hidden" id="t_num_facture" name="t_num_facture" value="FA00<?= $numerofacture; ?>">
