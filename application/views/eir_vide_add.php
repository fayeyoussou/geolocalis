...
<!--				<?php //if((isset($eir_videdetails))){ ?> N° <?php //echo (isset($eir_videdetails)) ? $eir_videdetails[0]['ei_numero']:'' ?>  <?php //}else{?> N° M<?//= $numeroeir_vide; }?> -->
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
			  ...
			  <li class="breadcrumb-item"><a href="<?= base_url(); ?>">EIR VIDE</a></li>				
        ...
        <div class="card card-primary card-tabs">
          <div class="card-header p-0 pt-1">
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill" href="#custom-tabs-one-home" role="tab" aria-controls="custom-tabs-one-home" aria-selected="true">EIR VIDES</a>
              </li>
              <li class="nav-item">
...
<form method="post" id="" class="card" action="<?php echo base_url();?>eir_vide/addeir_vide">
	<div class="card-body">
            <div class="row">
               <div class="col-md-5">
					...
					<table id="eir_videtbl" class="datatableexport table card-table table-vcenter">	
                      ...
                      <?php $count=1;
                        ...
                        <tr>
                           ...
                           <td> <?php echo output($eir_vides['t_num_facture']);?></td>
                           <td> <?php echo output($eir_vides['pr_numero']);?></td>
                           <td> <?php echo output($eir_vides['mi_numero']);?></td>                           
							<td> <?php echo output($eir_vides['ei_mission_id']);?></td>

                        <td>  <span class="badge <?php echo ($eir_vides['ei_isactive']=='1') ? 'badge-success' : 'badge-danger'; ?> "><?php echo ($eir_vides['ei_isactive']=='1') ? 'Plein' : 'Vide'; ?></span>  </td>
                          <?php //if(userpereir_plein('lr_ei_edit')) { ?>
                              <td>
                            <a class="icon" href="<?php echo base_url(); ?>eir_plein/editeir_vide/<?php echo output($eir_vides['ei_id']); ?>">
