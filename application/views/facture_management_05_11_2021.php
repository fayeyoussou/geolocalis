...
<!--                          <th>Statut facture</th>-->
                      ...
                      <?php if(!empty($facturelist)){ 
                        ...
                        <tr>
                          ...
                          <td> <?php //echo ucfirst($facturelists['t_num_facture']); ?> <?php if(isset($facturelists['t_num_facture'])){echo output($facturelists['t_num_facture']);}else {echo output($facturelists['t_num_proforma']);} ?></td>
