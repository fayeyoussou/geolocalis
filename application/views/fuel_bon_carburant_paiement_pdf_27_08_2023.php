...
$paiement = join_multi_select($bon_carburantdetails['ccrp_bon_carburant_id'], 'fuel_bon_carburant', 'bc_id', 'bc_numero');

$html = '
<table cellpadding="0" cellspacing="0" border="0" style="text-align:center;" >

<tr>
	<td style="text-align:left;" height="'.$taille.'" width="250"><b>N° BON CARBURANT :</b>
	</td>
	<td height="'.$taille.'" width="250">'.$paiement.'
	</td>		
</tr>
