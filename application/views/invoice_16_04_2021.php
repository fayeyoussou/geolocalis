...
<div class="wrapper">
  ...
  <section class="col-12" class="invoice">
    ...
    <div class="row invoice-info">
      ...
      <!-- /.col -->
      <div class="col-sm-4 invoice-col">
        <b>Facture #<?= output($data['s_inovice_prefix']).date('Ym').$tripdetails['t_id']; ?></b><br>
        <br>
        <b>N° de commande:</b> <?= output($tripdetails['t_id']) ?><br>
      ...
      <div class="col-12 table-responsive">
        <table class="table table-striped">
          ...
          <tr>
            ...
            <td>De  <br> <?= $tripdetails['t_trip_fromlocation']; ?> <br> to <br><?= $tripdetails['t_trip_tolocation']; ?> </td>
