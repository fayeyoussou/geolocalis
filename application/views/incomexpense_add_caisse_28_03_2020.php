    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-7">
            <h1 class="m-0 text-dark"><?php echo (isset($incomexpensedetails))?'Modifier mouvement de caisse':'Ajouter mouvement de caisse' ?> N° CAI000<?= $numero_compteurcaisse; ?>
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-5">
          ...
          <div class="card-body">
                 ...
                 <input type="hidden" id="ie_created_date" name="ie_created_date" value="<?php echo date('Y-m-d h:i:s'); ?>">
                  ...
                  <input type="hidden" id="ie_type" name="ie_type" value="<?php echo "income"; ?>">           
			  	  <input type="hidden" id="ie_numero_enregistrement" name="ie_numero_enregistrement" value="CAI000<?= $numero_compteurcaisse; ?>">			  
...
<section class="content">
   <div class="container-fluid">
       <form method="post" id="incomeexpense_report" class="card basicvalidation" action="<?php echo base_url();?>incomexpense/journalcaisse"><!--journalreglement_facture-->
<!--     <form method="post" id="incomeexpense_report" class="card basicvalidation" action="<?php //echo base_url();?>reports/incomeexpense">-->
         <div class="card-body">
            <div class="row">
				...
				<div class="col-md-4">
				<div class="form-group">
                     <label class="form-label">N° caisse<span class="form-required"></span></label>
                     <input type="text" required="true" class="form-control form-control-sm" value="<?php echo isset($_POST['ie_numero_enregistrement']) ? $_POST['ie_numero_enregistrement'] : ''; ?>" id="ie_numero_enregistrement" name="ie_numero_enregistrement" placeholder="N° caisse">
                   </div>	
                 </div>				
...
<!--					<div class="col-sm-6 col-md-4">
                      <div class="form-group">
                          <label class="form-label">Montant minimum <span class="form-required"></span></label>
                         <input type="text" class="form-control" id="ie_numero_min" name="ie_numero_min" value="<?php //echo isset($_POST['ie_numero_min']) ? $_POST['ie_numero_min'] : ''; ?>" placeholder="Montant minimum">
					...
					<div class="col-sm-6 col-md-4">
                      <div class="form-group">
                          <label class="form-label">Montant maximum <span class="form-required"></span></label>
                         <input type="text" class="form-control" id="ie_numero_max" name="ie_numero_max" value="<?php //echo isset($_POST['ie_numero_max']) ? $_POST['ie_numero_max'] : ''; ?>" placeholder="Montant maximum">
				...
				<div class="col-sm-6 col-md-4">
                      <div class="form-group">
                          <label class="form-label">N° <span class="form-required"></span></label>
