...
/**/	public function viewmission_suite($mi_id) { 
		...
		$requete="";
		$requete="mi_trip_id=t_id AND mi_conteneur_id=co_id AND mi_trip_id=pr_trip_id";
		return $this->db->select('*')->from('trip_mission,trips,trip_conteneur,trip_pregate')->where($requete)->get()->result_array();	
