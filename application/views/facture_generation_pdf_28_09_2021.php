...
if($facturedetails['t_num_facture']!="") {
$tbl = '
...
}else
{
  $html .= '<h5><tr style="background-color:#F2F2F2;color:#000000;">
            ...
            </tr></h5>Arrétée la présente proforma à la somme de <b>'.$montant_lettre.'</b> FCFA';
}
...
$pdf->Write(0, 'CETTE FACTURE NE DISPOSE PAS ENCORE DE CONTENEUR', '', 0, 'C', true, 0, false, false, 0);// $pdf->writeHTML($html, false, false, true, false, '');   
    ...
    {
$pdf->Write(0, 'CETTE PROFORMA NE DISPOSE PAS ENCORE DE CONTENEUR', '', 0, 'C', true, 0, false, false, 0);// $pdf->writeHTML($html, false, false, true, false, '');   
