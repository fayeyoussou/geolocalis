...
$tbl = '<table cellspacing="0" cellpadding="0" border="0">
    <tr>';
    $pdf->SetFont('helvetica', 'B', 16);
    $tbl .= '<td rowspan="3">FACTURE N°'.$facturedetails['t_num_facture'].'</td>';
    $pdf->SetFont('helvetica', '', 12);
    $tbl .= '<td>FACTURE N°'.$facturedetails['t_num_facture'].'<br>FACTURE N°'.$facturedetails['t_num_facture'].'<br>FACTURE N°'.$facturedetails['t_num_facture'].'</td>
        <td>FACTURE N°'.$facturedetails['t_num_facture'].'<br>FACTURE N°'.$facturedetails['t_num_facture'].'<br>FACTURE N°'.$facturedetails['t_num_facture'].'<br>FACTURE N°'.$facturedetails['t_num_facture'].'</td>
    </tr>';
    $pdf->SetFont('helvetica', '', 12);
    $tbl .= '<tr>
