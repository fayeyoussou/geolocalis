<div class="content-header">
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6">
            <h1 class="m-0 text-dark">Gestion des véhicules
            </h1>
         </div>
         <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               <li class="breadcrumb-item"><a href="<?= base_url(); ?>/dashboard">Tableau de bord</a></li>
               <li class="breadcrumb-item active">Gestion des véhicules</li>
            </ol>
         </div>
      </div>
   </div>
...
<!--                        <td><?php //echo output($vehiclelists['v_name']); ?></td>-->
                        ...
                        <td><?php echo output($vehiclelists['v_consommation']); ?></td>
                        <td><?php echo output($vehiclelists['gr_name']); ?></td>
                        <td><?php echo output($vehiclelists['v_created_date']); ?></td>
