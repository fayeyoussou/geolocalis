...
$(document).ready(function(){
 $('#mi_lieu_restitution_id').change(function(){
  var mi_lieu_restitution_id = $('#mi_lieu_restitution_id').val();
  if(mi_lieu_restitution_id != '')
  {
   $.ajax({
     url:"<?php echo base_url(); ?>eir_plein/fetch_information_mission",
//   url:"<?php //echo base_url(); ?>mission/fetch_state",
    method:"POST",
    data:{mi_lieu_restitution_id:mi_lieu_restitution_id},
    success:function(data)
    {
     $('#mi_id').html(data);
//     $('#city').html('<option value="">Select City-BAS</option>');
