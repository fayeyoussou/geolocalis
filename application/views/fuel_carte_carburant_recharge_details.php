    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Détails du paiement carte carburant N°<?= $cartedetails['ccr_number_cheque']; ?> 
...
<div class="tab-pane fade show active" id="custom-tabs-one-paiement_carburant" role="tabpanel" aria-labelledby="custom-tabs-one-paiement_carburant-tab">
...
<!--                <a href="#" class="btn btn-sm btn-success <?//= ($cartedetails['cc_restant'] - $totalpaidamt==0)?'disabled':'' ?>" data-toggle="modal" data-target="#modal-Addrecharge">AJOUTER UNE RECHARGE</a>
                ...
                <a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#modal-paiement_carburant">AJOUTER UN PAIEMENT CARBURANT</a>
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="triprecharges" action="<?= base_url() ?>fuel_bon_carburant/insertfuel_bon_carburant" method="post">
				...
				<div class="form-group row">
                 ...
                 <input type="hidden" class="form-control" value="<?= $cartedetails['ccr_id']; ?>" name="bc_carte_id" id="bc_carte_id" >
