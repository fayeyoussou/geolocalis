...
<!--                <div class="form-group row">
                ...
                <div class="form-group row">
                 ...
                 <input type="hidden" class="form-control" value="<?= $facturedetails['t_id']; ?>" name="co_trip_id" id="co_trip_id">
                  <input type="hidden" class="form-control" value="immobilisation" name="type_facture" id="type_facture">
...
<!--                 <input type="text" class="form-control" value="expense" name="ie_type" id="ie_type">-->
                 <input type="hidden" class="form-control" value="<?= $facturedetails['t_id']; ?>" name="co_trip_id" id="co_trip_id">
                  <input type="hidden" class="form-control" value="forfait" name="type_facture" id="type_facture">
			<div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-default" data-dismiss="modal">FERMER</button>
