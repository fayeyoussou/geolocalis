...
<li class="nav-item">
                <a class="nav-link" id="custom-tabs-one-home-perte-tab" data-toggle="pill" href="#custom-tabs-one-home-perte" role="tab" aria-controls="custom-tabs-one-home-perte" aria-selected="true">AJOUTER PERTE</a>
              </li>				
              <li class="nav-item">
...
<div class="col-sm-6 col-md-3">
              ...
              <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" name="mi_quantite_carburant" id="mi_quantite_carburant"  value="<?php echo (isset($missiondetails)) ? $missiondetails[0]['mi_quantite_carburant']:'' ?>"<?php //echo 'value="'.$row_quantite->bc_restant.'"' ?> class="form-control" placeholder="Quantité carburant">
                  </div>
               </div> 					  
...
<div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <select id="mi_conteneur_id" name="mi_conteneur_id[]" multiple class="select2" >
...
<!-- Fin Carte Carburant-->                    
				...
				<div class="col-sm-4 col-md-3">
                      <div class="form-group">
                          <label for="mi_type_transport" class="form-label">Type de transport</label>
                        <select id="mi_type_transport" name="mi_type_transport" class="form-control selectized"required="">
                          <option value="">Selectionner le type de transport</option> 
                          <option <?php echo (isset($missiondetails) && $missiondetails[0]['mi_type_transport']==1) ? 'selected':'' ?> value="1">Décrocher</option> 
                          <option <?php echo (isset($missiondetails) && $missiondetails[0]['mi_type_transport']==0) ? 'selected':'' ?> value="2">Mettre à terre</option>
                          <option <?php echo (isset($missiondetails) && $missiondetails[0]['mi_type_transport']==0) ? 'selected':'' ?> value="3">Livrer</option>							
                        </select>
                      </div>
                    </div>					  
  ...
  <!----><div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label"> 1Type de transport<span class="form-required">*</span></label>
				  
<!-- BEGIN SELECT-->
					  
   <select name="mi_type_transport" id="mi_type_transport" class="form-control selectized">
    <option value="">1Selectionner le Type de transport</option>
    <?php
...
<div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label"> Lieu transport<span class="form-required">*</span></label>
                     <select id="mi_lieu_transport" name="mi_lieu_transport"class="form-control selectized">
						  <!--<select id="mi_conteneur_id" class="form-control selectized" name="mi_conteneur_id[]" multiple   >input-lg-->
                        <option value="">&Sélectionner le lieu transport</option>
...
<div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label">Motif de la perte<span class="form-required">*</span></label>
                     <select id="mi_motif_perte_id" class="form-control selectized" name="mi_motif_perte_id" >
                        <option value="">Sélectionner le motif de la perte</option>
                        <?php  foreach ($trip_mission_motif_pertelist as $key => $trip_mission_motif_pertelists) { ?>
                        <option <?php if((isset($missiondetails)) && $missiondetails[0]['mi_motif_perte_id'] == $trip_mission_motif_pertelists['mp_id']){ echo 'selected';} ?> value="<?php echo output($trip_mission_motif_pertelists['mp_id']) ?>"><?php echo output($trip_mission_motif_pertelists['mp_name']); ?></option>
                        <?php  } ?>
                     </select>
                  </div>
               </div>					  
...
<!--				<div id="mi_bon_carburant_id">
              ...
              <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label">Quantité carburant (litre) <span class="form-required">*</span></label>
                     <input type="text" name="mi_quantite_carburant" id="mi_quantite_carburant"  value="value="<?php echo (isset($missiondetails)) ? $missiondetails[0]['mi_quantite_carburant']:'' ?>""<?php //echo 'value="'.$row_quantite->bc_restant.'"' ?> class="form-control" placeholder="Quantité carburant">
                  </div>
               </div> 					  
                    ...
                    <table id="missiontbl" class="datatableexport table card-table table-vcenter">
                      ...
                      <?php $count=1;
                        ...
                        <tr>
                         ...
                         <td><?php //echo output($missions['co_numero_conteneur']); ?><?php //echo ucfirst($missions['conteneur']->co_numero_conteneur); ?><?= (isset($missions['conteneur']->co_numero_conteneur))?$missions['conteneur']->co_numero_conteneur:'<span class="badge badge-danger">Non renseigné</span>'; ?></td>
                         <td><?php //echo output($missions['clr_name']); ?><?php //echo ucfirst($missions['lieu_restitution']->clr_name); ?><?php if($missions['mi_type_transport']==1) {echo "Décrocher";} ?><?php if($missions['mi_type_transport']==2) {echo "Mettre à terre";} ?><?php if($missions['mi_type_transport']==3) {echo "Livrer";} ?></td>
...
/* BEGIN LIEU RESTITUTION*/	
 /*$('#mi_type_transport').change(function(){
  var mi_type_transport = $('#mi_type_transport').val();
  if(mi_type_transport != '')
  {
   $.ajax({
     url:"<?php 
//echo base_url(); ?>mission/fetch_lieu_transport",
//   url:"<?php //echo base_url(); ?>mission/fetch_state",
    method:"POST",
    data:{mi_type_transport:mi_type_transport},
    success:function(data)
    {
     $('#mi_lieu_transport').html(data);
//     $('#city').html('<option value="">Select City-BAS</option>');
    }
   });
  }
...
/* BEGIN LIEU TRANSPORT*/	
 $('#mi_type_transport').change(function(){
  var mi_type_transport = $('#mi_type_transport').val();
  if(mi_type_transport != '')
  {
   $.ajax({
     url:"<?php echo base_url(); ?>mission/fetch_lieu_transport",
//   url:"<?php //echo base_url(); ?>mission/fetch_state",
    method:"POST",
    data:{mi_type_transport:mi_type_transport},
    success:function(data)
