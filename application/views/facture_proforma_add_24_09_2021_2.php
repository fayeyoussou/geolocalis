...
<!-- Fin zone-->  
               ...
               <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_nom_navire']:'' ?>" name="t_nom_navire" id="t_nom_navire" class="form-control selectized" placeholder="Nom du navire">
                  </div>
               </div>
               <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label">Référence / N° BL<span class="form-required">*</span></label>
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_reference']:'' ?>" name="t_reference" id="t_reference" class="form-control selectized" placeholder="Référence / N° BL" required="true" >
                  </div>
               </div>
...
<!-- -->                <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_nombre_conteneur']:'' ?>" name="t_nombre_conteneur" value="" class="form-control selectized" placeholder="Nombre de conteneur" required="true" >
                  </div>
               </div>               
...
<!--                <div class="col-sm-6 col-md-3">
            ...
            <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_nombre_ags']:'' ?>" name="t_nombre_ags" id="t_nombre_ags" class="form-control selectized" placeholder="Nombre AGS">
                  </div>
               </div>                 
  <!-- debut AGS-->                  
  ...
  <!-- debut taxe-->       
            ...
            <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_ristourne_amount']:'' ?>" name="t_ristourne_amount" id="t_ristourne_amount" class="form-control selectized" placeholder="Montant Ristourne">
                  </div>
               </div>                
...
<!-- Debut Type de reglement--> 
               ...
               <div class="col-sm-6 col-md-3">
                   <div class="form-group">
                     ...
                     <select id="t_type_reglement"  class="form-control selectized" required="true"  name="t_type_reglement">
...
<!---->               <div class="col-sm-6 col-md-3">
                   <div class="form-group">
                     ...
                     <select id="t_reglement"  class="form-control selectized" required="true"  name="t_reglement">
                ...
                <div class="col-sm-6 col-md-6">
                      <div class="form-group">
                       <label class="form-label">Commentaire</label>
                          <input type="text" class="form-control selectized" id="t_desc" value="<?php echo (isset($fueldetails)) ? $fueldetails[0]['t_desc']:'' ?>" name="t_desc" placeholder="Commentaire sur le carburant">
                      </div>
                    </div>                
...
<!-- Fin zone-->  
               ...
               <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label">Référence / N° BL<span class="form-required"></span></label>
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_reference']:'' ?>" name="t_reference" id="t_reference" class="form-control selectized" placeholder="Référence / N° BL"  >
                  </div>
               </div>
...
<!-- -->                <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_nombre_jour_immobilisation']:'' ?>" name="t_nombre_jour_immobilisation" value="" class="form-control selectized" placeholder="Nombre de jours immobilisation" required="true">
                  </div>
               </div>               
...
<!-- debut Nature-->
                ...
                <div class="col-sm-6 col-md-6">
                      <div class="form-group">
                       <label class="form-label">Commentaire</label>
                          <input type="text" class="form-control selectized" id="t_desc" value="<?php echo (isset($fueldetails)) ? $fueldetails[0]['t_desc']:'' ?>" name="t_desc" placeholder="Commentaire ">
                      </div>
                    </div>                
...
<!-- Debut Type de reglement--> 
               ...
               <div class="col-sm-6 col-md-3">
                   <div class="form-group">
                     <label class="form-label">Conditions de réglement<span class="form-required">*</span></label>
                     <select id="t_type_reglement"  class="form-control selectized" required="true"  name="t_type_reglement">
                       <option value="">Selectionner la condition de réglement</option>
                        <?php  foreach ($type_reglementlist as $key => $type_reglementlists) { ?>
                        <option <?php if((isset($facturedetails)) && $facturedetails[0]['t_type_reglement'] == $type_reglementlists['tr_id']){ echo 'selected';} ?> value="<?php echo output($type_reglementlists['tr_id']) ?>"><?php echo output($type_reglementlists['tr_name']); ?> </option>
                        <?php  } ?>
                     </select>
...
<?php if((isset($facturedetails))){}else{ ?>
          ...
          <input type="hidden" id="t_modele_facture" name="t_modele_facture" value="PROFORMA">                              
<?php } ?>
          <input type="text" id="cpt_numero" name="cpt_numero" value="<?= $numeroproforma; ?>">                              
