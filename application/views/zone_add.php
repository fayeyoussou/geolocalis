          ...
          <div class="card-body"> 
                  ...
                  <div class="row">
                   <input type="hidden" name="z_id" id="z_id" value="<?php echo (isset($zonedetails)) ? $zonedetails[0]['z_id']:'' ?>" >
                    ...
                    <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         <label class="form-label">Plafond carburant <span class="form-required text-red">*</span></label>
                          <input type="text" required="true" class="form-control" value="<?php echo (isset($zonedetails)) ? $zonedetails[0]['z_plafond_carburant']:'' ?>" id="z_plafond_carburant" name="z_plafond_carburant" placeholder="Plafond carburant">
                      </div>
                    </div>					  
                      
                      <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         <label class="form-label">Nombre de jours de franchise <span class="form-required text-red">*</span></label>
                          <input type="text" required="true" class="form-control" value="<?php echo (isset($zonedetails)) ? $zonedetails[0]['z_nombre_jour_detention']:'' ?>" id="z_nombre_jour_detention" name="z_nombre_jour_detention" placeholder="Nombre de jours de franchise">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         <label class="form-label">Montant Ristourne 20 pieds <span class="form-required text-red">*</span></label>
                          <input type="text" required="true" class="form-control" value="<?php echo (isset($zonedetails)) ? $zonedetails[0]['z_montant_ristourne_20']:'' ?>" id="z_montant_ristourne_20" name="z_montant_ristourne_20" placeholder="Montant Ristourne 20 pieds">

                       </div>
                     </div>
                        
                    <div class="form-group">
                         <label class="form-label">Montant Ristourne 40 pieds <span class="form-required text-red">*</span></label>
                          <input type="text" required="true" class="form-control" value="<?php echo (isset($zonedetails)) ? $zonedetails[0]['z_montant_ristourne_40']:'' ?>" id="z_montant_ristourne_40" name="z_montant_ristourne_40" placeholder="Montant Ristourne 40 pieds">
