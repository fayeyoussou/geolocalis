                    ...
                    <table id="facturetbl" class="table card-table table-vcenter text-nowrap">
                      ...
                      <?php if(!empty($facturelist)){ 
                        ...
                        <tr>
                           ...
                           <td> <?php echo output($facturelists['t_vechicle_details']->v_name); ?></td>
                           <td><?php echo ucfirst($facturelists['t_type']); ?></td>
                           <td><?= (isset($facturelists['t_driver_details']->d_name))?$facturelists['t_driver_details']->d_name:'<span class="badge badge-danger">Yet to Assign</span>'; ?></td>
                           <td> <?php 
