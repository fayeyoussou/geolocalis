...
<div class="col-sm-6 col-md-3">
                  ...
                  <div class="form-group">
                     <select id="i_customer"  class="form-control selectized" required="true" name="i_customer">
                        ...
                        <option <?php if((isset($tripdetails)) && $tripdetails[0]['i_customer'] == $customerlists['c_id']){ echo 'selected';} ?> value="<?php echo output($customerlists['c_id']) ?>"><?php echo output($customerlists['c_name']) ?></option>
                        <?php  } ?>
                     </select>
                  </div>
               </div>            
 <!-- Debut client-->                     
                    ...
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                          ...
                          <input type="text" required="true" class="form-control" value="<?php echo (isset($invoicedetails)) ? $invoicedetails[0]['i_amount']:'' ?>" id="i_amount" name="i_amount" placeholder="Nom de la carte ">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                         <label class="form-label">Numéro de la carte<span class="form-required">*</span></label>
                          <input type="text" required="true" class="form-control" value="<?php echo (isset($invoicedetails)) ? $invoicedetails[0]['i_num_facture']:'' ?>" id="i_num_facture" name="i_num_facture" placeholder="Numéro de la carte">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-8">
                      <div class="form-group">
                       <label class="form-label">Description<span class="form-required">*</span></label>
                        <textarea class="form-control" required="true" id="i_desc" autocomplete="off" placeholder="Description"  name="i_desc"><?php echo (isset($invoicedetails)) ? $invoicedetails[0]['i_desc']:'' ?></textarea>
                      </div>
                    </div>
