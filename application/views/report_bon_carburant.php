...
<section class="content">
  ...
  <!--                <li class="nav-item"><a class="nav-link active" href="#annulation_mission" data-toggle="tab">ANNULATION MISSION</a></li>-->
              ...
              <!---->  <li class="nav-item"><a class="nav-link active" href="#carburant" data-toggle="tab">VALIDATION BONS DE CARBURANT</a></li>
					...
					<li class="nav-item"><a class="nav-link" href="#list_bc" data-toggle="tab">LISTE BC</a></li>					<!---->
               </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
...
-->                          <th>Statut</th>
                      ...
                      <?php if(!empty($fuel_bon_carburant_tab_paiement_list)){  $count=1;
                        ...
                        <tr>
                           ...
                           <td> <?php echo output($paiement['ccrp_numero']); ?><?php //echo join_multi_select($paiement['ccrp_bon_carburant_id'], 'fuel_bon_carburant', 'bc_id', 'bc_numero'); ?></td>
...
<!--debut validation-->                                    
				...
				/*if(userpermission('lr_fuel_validation')) {*/ 			   
                   ...
                   <?php } else { ?>  
                     ...
                     <?php }  // fin controle?>
					 <?php /*}*/  // fin controle?>			<a data-toggle="tooltip" data-placement="top" title="Générer la facture PDF" class="icon" href="<?php echo base_url(); ?>fuel_bon_carburant/fuel_bon_carburant_paiement_pdf/<?php echo output($paiement['ccrp_id']); ?>" target="_blank">
...
-->                          <th>Validation</th>
                      ...
                      <tbody>
                      <?php if(!empty($list_fuel_bon_carburant)){  $count=1;
                           foreach($list_fuel_bon_carburant as $fuels){
                           ?>
                        <tr>
                           <td> <?php echo output($count); $count++; ?></td>
                            <td> <?php echo output($fuels['bc_date']); ?></td>
...
<!--debut validation-->                                    
				...
				if(userpermission('lr_fuel_validation')) { 			   
                   ...
                   <?php } else { ?>  
                     ...
                     <?php }  // fin controle?>
					 <?php }  // fin controle?>				<a class="icon" href="<?php echo base_url(); ?>fuel_bon_carburant/editfuel_bon_carburant/<?php echo output($fuels['bc_id']); ?>">
