    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?php echo (isset($fuel_carte_peagedetails))?'Modifier une carte de péage':'Ajouter une carte de péage' ?>
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url(); ?>/dashboard">cartes de péage</a></li>
              <li class="breadcrumb-item active"><?php echo (isset($fuel_carte_peagedetails))?'Modifier cartes de péage':'Ajouter cartes de péage' ?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
                   ...
                   <input type="hidden" name="cp_id" id="cp_id" value="<?php echo (isset($fuel_carte_peagedetails)) ? $fuel_carte_peagedetails[0]['cp_id']:'' ?>" >
                    ...
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                          ...
                          <input type="text" required="true" class="form-control" value="<?php echo (isset($fuel_carte_peagedetails)) ? $fuel_carte_peagedetails[0]['cp_name']:'' ?>" id="cp_name" name="cp_name" placeholder="Nom de la carte ">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                         <label class="form-label">Numéro de la carte<span class="form-required">*</span></label>
                          <input type="text" required="true" class="form-control" value="<?php echo (isset($fuel_carte_peagedetails)) ? $fuel_carte_peagedetails[0]['cp_numero']:'' ?>" id="cp_numero" name="cp_numero" placeholder="Numéro de la carte">
                      </div>
                    </div>
      ...
      <div class="modal-footer">
                  ...
                  <button type="submit" class="btn btn-primary"> <?php echo (isset($fuel_carte_peagedetails))?'Modifier carte de péage':'Ajouter carte de péage' ?></button>
      </div>
    </div>
    </form>
