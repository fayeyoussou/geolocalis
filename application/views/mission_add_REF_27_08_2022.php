...
<div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <select id="conteneur" name="conteneur" class="form-control input-lg">
...
/*$(document).ready(function(){
 $('#pregate').change(function(){
  var pr_trip_id = $('#pregate').val();
  if(pr_trip_id != '')
  {
   $.ajax({
    url:"<?php //echo base_url(); ?>mission/fetch_conteneur",
    method:"POST",
    data:{pr_trip_id:pr_trip_id},
  ...
  {
   $('#conteneur').html('<option value="">Select State else</option>');
   $('#city').html('<option value="">Select City else</option>');
  }
 });

 $('#conteneur').change(function(){
  var co_id = $('#conteneur').val();
  if(co_id != '')
  {
   $.ajax({
...
$(document).ready(function(){
 $('#pr_trip_id').change(function(){
  var pr_trip_id = $('#pr_trip_id').val();
  if(pr_trip_id != '')
  {
   $.ajax({
     url:"<?php echo base_url(); ?>mission/fetch_conteneur",
