    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Gestion des voyages
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url(); ?>/dashboard">Tableau de bord</a></li>
              <li class="breadcrumb-item active">Gestion des voyages</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                    ...
                    <table id="invoicetbl" class="table card-table table-vcenter text-nowrap">
                      ...
                      <?php if(!empty($invoicelist)){ 
                        ...
                        <tr>
                           ...
                           <td> <?php //echo ucfirst($invoicelists['t_customer_details']->c_name); ?></td>
                           ...
                           <td> <?php /*
                              switch($invoicelists['t_invoice_status']){
                                  case 'ongoing':
