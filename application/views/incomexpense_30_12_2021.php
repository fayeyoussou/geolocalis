                    ...
                    <table id="incomexpensetbl" class="table card-table">
                      ...
                      <?php $count=1;
                        ...
                        <tr>
                           ...
                           <td> <?php echo join_multi_select($incomexpenses['ie_id'], 'trips', 't_id', 't_id'); ?><?//= join_multi_select($incomexpenses->mi_trip, 'trips', 't_id', 't_num_facture'); ?><?php  //echo output($incomexpenses['ie_ieb_id']);//echo output($incomexpenses['facture']->t_num_facture); ?></td>
