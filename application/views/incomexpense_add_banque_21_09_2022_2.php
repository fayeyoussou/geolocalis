            ...
            <div class="row">
              <div class="col-5 col-sm-2">
                <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
                  ...
                  <a class="nav-link" id="vert-tabs-carburants-tab" data-toggle="pill" href="#vert-tabs-carburants" role="tab" aria-controls="vert-tabs-carburants" aria-selected="false">CARBURANT</a>					
...
<section class="content">
      <div class="container-fluid">
       	     <form method="post" id="Income_Expense" class="card" action="<?php echo base_url();?>Incomexpense/<?php echo (isset($incomexpensedetails))?'updateincomexpense':'insertincomexpense_banque_carburant'; ?>">
          <div class="card-body">
...
<!-- DEBUT CARBURANT-->					  
<div class="tab-pane fade" id="vert-tabs-carburants" role="tabpanel" aria-labelledby="vert-tabs-carburants-tab">
      ...
      <div class="container-fluid">
          ...
          <div class="card-body">
				...
				<div class="col-sm-6 col-md-4">
                 ...
                 <input type="hidden" id="ie_created_date" name="ie_created_date" value="<?php echo date('Y-m-d h:i:s'); ?>">
                  <input type="hidden" id="ie_type_mouvement" name="ie_type_mouvement" value="<?php echo "BANQUE"; ?>">
                   <input type="hidden" id="ie_compte_id" name="ie_compte_id" value="174">
                 <input type="hidden" id="ie_type" name="ie_type" value="<?php echo "expense"; ?>"><!--SORITE-->
                  <input type="hidden" id="ie_espece_cheque" name="ie_espece_cheque" value="<?php echo "CHEQUE"; ?>"><!--ENTREE-->
			      <input type="hidden" id="ie_numero_enregistrement" name="ie_numero_enregistrement" value="B<?= $numero_compteurbanque; ?>">			  
