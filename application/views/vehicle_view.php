    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Détails du véhicule
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<!--                <p class="text-muted text-center"><?//= ucwords($vehicledetails['v_type']); ?></p>-->
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Gestion des voyages</b> <a class="float-right"><?= count($bookings); ?></a>
                  </li>
                  <li class="list-group-item">
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                   <li class="nav-item"><a class="nav-link active" href="#basicinfo" data-toggle="tab">Informations basique</a></li>
                  <li class="nav-item"><a class="nav-link " href="#bookings" data-toggle="tab">Voyages</a></li>
                  <li class="nav-item"><a class="nav-link" href="#vechicle_geofence" data-toggle="tab">Géorepérage</a></li>
                <li class="nav-item"><a class="nav-link" href="#vechicle_incomexpense" data-toggle="tab">Revenus et dépenses</a></li>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
...
<!---->              <tr>
                      ...
                      <td><?= output($vehicledetails['v_date_mise_service']) ?></td>
                    </tr>
                     ...
                     <tr>
                      <td>Nom d'utilisateur de l'API GPS</td>
                      <td><?= output($vehicledetails['v_api_username']) ?></td>
                    </tr>
                     <tr>
                      <td>Mot de passe de l'API GPS</td>
