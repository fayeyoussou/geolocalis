    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?php echo (isset($incomexpensedetails))?'Modifier Caisse (Revenus / Dépenses)':'Ajouter Caisse (Revenus / Dépenses)' ?>
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url(); ?>/dashboard">Client</a></li>
              <li class="breadcrumb-item active"><?php echo (isset($incomexpensedetails))?'Modifier Caisse (Revenus / Dépenses)':'Ajouter Caisse (Revenus / Dépenses)' ?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
                   ...
                   <input type="hidden" name="ie_id" id="ie_id" value="<?php echo (isset($incomexpensedetails)) ? $incomexpensedetails[0]['ie_id']:'' ?>" >
                    ...
                    <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                        ...
                        <option <?php if((isset($incomexpensedetails)) && $incomexpensedetails[0]['ie_type'] == 'revenu'){ echo 'selected';} ?> value="revenu">Revenus</option>
                        <option <?php if((isset($incomexpensedetails)) && $incomexpensedetails[0]['ie_type'] == 'depense'){ echo 'selected';} ?> value="depense">Dépenses</option>
                      </select>
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         ...
                         <input type="text" class="form-control datepicker" id="ie_date" name="ie_date" value="<?php echo (isset($incomexpensedetails)) ? $incomexpensedetails[0]['ie_date']:'' ?>" placeholder="Date Revenus / Dépenses">
      ...
      <div class="modal-footer">
                  ...
                  <button type="submit" class="btn btn-primary"> <?php echo (isset($incomexpensedetails))?'Modifier Caisse':'Ajouter Caisse' ?></button>
      </div>
    </form>
             </div>
    </section>
