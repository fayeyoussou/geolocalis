...
<!-- BEGIN SELECT-->
   ...
   <select name="ei_trip_id" id="mi_trip_id" class="form-control selectized">
    <option value="">Selectionner BL</option>
    <?php
    foreach($pregate as $row)
    {
     echo '<option value="'.$row->t_id.'">'.$row->t_reference.'</option>';
    }
    ?>
   </select>					  
<!-- END SELECT-->					  
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         ...
                         <input type="text" class="form-control datepicker" id="reservationdatetime"  name="ei_date" value="<?php echo (isset($eir_videdetails)) ? $eir_videdetails[0]['ei_date']:'' ?>" placeholder="Date EIR PLEINS">
