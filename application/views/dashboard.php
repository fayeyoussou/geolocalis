<div class="content-header">
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6">
            <h1 class="m-0 text-dark">Tableau de bord
            </h1>
         </div>
         <!-- /.col -->
         <div class="col-sm-6">
   ...
   <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
               ...
               <div class="info-box-content">
                  <span class="info-box-text">Total des véhicules</span>
         ...
         <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
               ...
               <div class="info-box-content">
                  <span class="info-box-text">Total conducteurs</span>
         ...
         <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
               ...
               <div class="info-box-content">
                  <span class="info-box-text">Voyages aujourd'hui</span>
      ...
      <div class="row">
            ...
            <div class="col-md-6">
               ...
               <div class="card">
                  <div class="card-header">
                     <h2 class="card-title">Encaissements & Décaissements</h2>
                  </div>
                  <div class="card-header border-transparent">
                     <div class="card-body">
                        ...
                        <div class="d-flex flex-row justify-content-end">
                           <span class="mr-2">
                           <i class="fas fa-square text-success"></i> Encaissements
                           </span>
                           <span>
                           <i class="fas fa-square text-danger"></i> Décaissements
                           </span>
                        </div>
                     </div>
                  </div>
            ...
            <div class="col-md-6">
               <div class="card">
                     ...
                     <ul class="todo-list ui-sortable" data-widget="todo-list">
                        ...
                        <li id="<?= $reminder['r_id'] ?>">
                           <span class="text">
                              <?= $reminder['r_message']. ' ';  ?>    
                              <div class="tools"> 
                                 <button type="button" data-id="<?= $reminder['r_id'] ?>" class="todayreminderread btn btn-block btn-outline-primary btn-xs">Marquer comme lu</button>                 
                              </div>
                           </span>
                        </li>
                  ...
                  <div class="card-footer clearfix">
                     <a href="<?= base_url() ?>reminder/addreminder"><button type="button" class="btn btn-info float-right"><i class="fas fa-plus"></i> Ajouter Rapport</button></a>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="col-sm-6 col-lg-6 ">
            <div class="card ">
               <div class="card-header">
                  <h2 class="card-title">Emplacement actuel du véhicule</h2>
               </div>
         ...
         <div class="col-sm-6 col-lg-6 ">
            <div class="card">
               <div class="card-header">
                  <h2 class="card-title">État de fonctionnement du véhicule</h2>
               </div>
