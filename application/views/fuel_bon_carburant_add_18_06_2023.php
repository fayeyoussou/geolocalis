...
<div class="col-sm-6 col-md-3">
                      ...
                      <div class="form-group">
                        ...
                        <option <?php if((isset($fueldetails)) && $fueldetails[0]['bc_compagnie_id'] == $fuel_compagnielists['ccc_id']){ echo 'selected';} ?> value="<?php echo output($fuel_compagnielists['ccc_id']) ?>"><?php echo output($fuel_compagnielists['ccc_name']); ?></option>
                        <?php  } ?>
                     </select>
                      </div>
                    </div>					  
...
<!-- BEGIN SELECT-->
		<!--<div class="col-sm-3 col-md-3">	-->			  
                      ...
                      <div class="form-group">
                            <select name="bc_compagnie_id" id="bc_compagnie_id" class="form-control selectized">
...
<tbody>
                  <?php //if (!empty($permissions = $this->permissions_model->get())): ?>
                    ...
                    <tr>
                      ...
                      <td width="50" class="text-center"><input type="checkbox" id="bc_id" class="check-select-p" name="permission[]" value="<?php //echo $row->bc_numero ?><?php echo output($row['bc_id']); ?>"></td>
                    </tr>
                    <?php endforeach ?>
                  <?php //else: ?>
...
<script>
 ...
 $('#bc_compagnie_id').change(function(){
  var bc_compagnie_id = $('#bc_compagnie_id').val();
  if(bc_compagnie_id != '')
  {
   $.ajax({
     url:"<?php echo base_url(); ?>fuel_bon_commande/fetch_numero_bon_commande",
//   url:"<?php //echo base_url(); ?>mission/fetch_state",
    method:"POST",
    data:{bc_compagnie_id:bc_compagnie_id},
