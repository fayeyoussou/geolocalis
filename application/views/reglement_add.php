...
<div class="col-sm-6 col-md-12">
                  <div class="form-group">
                     ...
                     <select id="tp_trip_id"  class="form-control selectized"  name="tp_trip_id" >
                        ...
                        <option <?php if((isset($reglementdetails)) && $reglementdetails[0]['tp_trip_id'] == $facturelists['t_id']){ echo 'selected';} ?> value="<?php echo output($facturelists['t_id']) ?>"> N°: <?php echo output($facturelists['t_num_facture']); ?> - du : <?php echo output($facturelists['c_name']); ?> </option>
                        <?php  } ?>
                     </select>
                  </div>
               </div>
