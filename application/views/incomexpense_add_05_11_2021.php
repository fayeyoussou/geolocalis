    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?php echo (isset($facturedetails))?'Modifier la facture':'Ajouter facture' ?><?php //((isset($facturedetails))){ ?>    N°  <?php //echo (isset($facturedetails)) ? $facturedetails[0]['t_num_facture']:'' ?>  <?php// }else{?> N° FA000<?//= $numerofacture; }?>  
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
