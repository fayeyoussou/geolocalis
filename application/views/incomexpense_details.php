        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Détails du réglement</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
-->                      <th>#</th>
                  ...
                  <tbody>
					...
					//if(isset($paiementreglementdetails)){
                      ...
                      <td><?php //echo $incomexpensedetails['tra_name']; ?></td>-->
...
-->                      <td><?php echo $paiementreglementdetails['tp_amount']; ?></td>
 ...
 <a class="icon" href="<?php echo base_url(); ?>incomexpense/reglementfacture_delete/<?php echo output($paiementreglementdetails['tp_id']); ?>/<?= $incomexpensedetails['ie_id']; ?>"><i class="fa fa-trash text-danger"></i>
</a>                      
...
-->                
                <a href="#" class="btn btn-sm btn-success <?= ($incomexpensedetails['ie_amount'] - $totalpaidamt==0)?'disabled':'' ?>" data-toggle="modal" data-target="#modal-AddPayment">Ajouter un Réglement</a>
        ...
        <form class="form-horizontal" id="trippayments" action="<?= base_url() ?>incomexpense/trippayment" method="post">
                <div class="card-body">
                  ...
                  <!--<div class="form-group row">
                    ...
                    <div class="form-group col-sm-8">
                     <select id="tp_trip_id" class="form-control" style="width: 100%;"  name="tp_trip_id">
                        ...
                        <?php  foreach ($facturetransitaire as $key => $facturelists) { ?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-group col-sm-8">
                       <input type="text" class="form-control" name="tp_amount" value="<?= $incomexpensedetails['ie_amount']-$totalpaidamt; ?>"  >
                    </div>
                  </div>                    
...
<!--                    <div class="form-group row">
                ...
                <!--<div class="form-group row">
                 ...
                 <input type="hidden" class="form-control" value="<?= "RAS"; ?>" name="tp_type" id="tp_type" placeholder="tp_type">
