...
-->                      <th>#</th>
                  ...
                  <tbody>
					...
					//if(isset($paiementreglementdetails)){
                      ...
                      <td><?php echo $paiementreglementdetails['facture_name']->t_num_facture;//echo output($paiementreglementdetails['tp_trip_id']); ?></td>
                      <td><?php echo output($paiementreglementdetails['tp_amount']); ?> FCFA
                         </td>

                      <td><?php echo output($paiementreglementdetails['tp_type']); ?></td>
