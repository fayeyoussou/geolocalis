...
-->                      <td><?php echo $depense_caisselist['ioc_amount']; ?></td>
 ...
 <a class="icon" href="<?php echo base_url(); ?>incomexpense/depense_caisse_suite_delete/<?= $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>/<?php echo output($depense_caisselist['ioc_id']); ?>"><i class="fa fa-trash text-danger"></i>
</a>                      
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="trippayments" action="<?= base_url() ?>incomexpense/insert_depensecaisse_suite" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-group col-sm-8">
                       <input type="text" class="form-control" name="ioc_amount"   >
                    </div>
                  </div>                    
...
<input type="hidden" class="form-control" value="<?= $this->uri->segment(4); ?>" name="ioc_caisse_id" id="ioc_caisse_id" placeholder="ioc_caisse_id">			
