<div class="content-header">
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6">
            <h1 class="m-0 text-dark">Liste des véhicules remorques
            </h1>
         </div>
         <!-- /.col -->
         <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               ...
               <li class="breadcrumb-item active">Liste des véhicules remorques</li>
            </ol>
         </div>
      </div>
   </div>
               ...
               <table id="custtbl" class="table card-table table-vcenter text-nowrap">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td><?php //echo output($vehicle_remorquelists['vr_type']); ?><span class="badge <?php echo ($vehicle_remorquelists['vr_type']=='Squelette_20') ? 'badge-success' : 'badge-danger'; ?> "><?php echo ($vehicle_remorquelists['vr_type']=='Squelette_20') ? '20 Pieds' : '40 Pieds'; ?></span> </td>
                        <td><?php echo output($vehicle_remorquelists['vr_created_date']); ?></td>
