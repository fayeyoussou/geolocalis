            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                   <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Transport") && ($url == "editfacture")){	?> 
					<li class="nav-item"><a class="nav-link active" href="#transport" data-toggle="tab">Transport</a></li> <?php }?> 
                     <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Exportation") && ($url == "editfacture")){	?>
					<li class="nav-item"><a class="nav-link active" href="#exportation" data-toggle="tab">Exportation</a></li> <?php }?> 
                     <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Transfert") && ($url == "editfacture")){	?>
					<li class="nav-item"><a class="nav-link active" href="#transfert" data-toggle="tab">Transfert</a></li> <?php }?> 
                 <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Immobilisation") && ($url == "editfacture")){	?>
					<li class="nav-item"><a class="nav-link active" href="#immobilisation" data-toggle="tab">Immobilisation</a></li> <?php }?> 
                     <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Manutentation") && ($url == "editfacture")){	?> <li class="nav-item"><a class="nav-link active" href="#manutentation" data-toggle="tab">Manutentation</a></li> <?php }?> 
					
    <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Detention") && ($url == "editfacture")){	?>
<li class="nav-item"><a class="nav-link active" href="#detention" data-toggle="tab">Détention</a></li>  <?php }?>  
    <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Forfait") && ($url == "editfacture")){	?>					
...
<div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_peage_amount']:'' ?>" name="t_peage_amount" id="t_peage_amount" class="form-control" placeholder="Montant péage" >
                  </div>
               </div>				
...
<?php } ?>
            ...
            <div class="card-footer text-right">
               <button type="submit" class="btn btn-primary"> <?php echo (isset($facturedetails))?'Modifier facture':'Ajouter facture Transport' ?></button>
            </div>
      </form>
...
<?php } // End controle transport?>
 <!--Debut transport-->               
    ...
    <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Exportation") && ($url == "editfacture")){	?>					
                  <div class="active tab-pane" id="exportation">
                    <!-- The timeline -->
<div class="post">
                      <div class="user-block">
<!--exportation-->
...
<?php } ?>
            ...
            <input type="hidden" id="t_created_date" name="t_created_date" value="<?php echo date('Y-m-d h:i:s'); ?>">
            <div class="card-footer text-right">
               <button type="submit" class="btn btn-primary"> <?php echo (isset($facturedetails))?'Modifier facture':'Ajouter facture Export' ?></button>
            </div>
      </form>
...
<?php }// end controle exportation?>					
    <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Transfert") && ($url == "editfacture")){	?>
                  <div class="active tab-pane" id="transfert">
<div class="post">
                      <div class="user-block">
tranfert
                          <form method="post" id="facture_add" class="card"  action="<?php echo base_url();?>facture/<?php echo (isset($facturedetails))?'updatefacture':'insertfacture'; ?>">
...
<?php } ?>
            ...
            <input type="hidden" id="t_created_date" name="t_created_date" value="<?php echo date('Y-m-d h:i:s'); ?>">
            <div class="card-footer text-right">
               <button type="submit" class="btn btn-primary"> <?php echo (isset($facturedetails))?'Modifier facture':'Ajouter facture Transfert' ?></button>
            </div>
      </form>
...
<?php }// end controle exportation?>					
    <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Manutentation") && ($url == "editfacture")){	?>
					
                  <!-- /.tab-pane -->
                  <div class="active tab-pane" id="manutentation">
                    <!-- The timeline -->
<div class="post">
                      <div class="user-block">
manutentation
...
<?php }// end controle exportation?>					
    <?php if((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Detention"){	?>					
                  ...
                  <div class="active tab-pane" id="detention">
                    <div class="post">
                      <div class="user-block">
