...
<form method="post" id="" class="card" action="<?php echo base_url();?>eir_plein/addeir_plein">
	<div class="card-body">
            <div class="row">
               <div class="col-md-5">
					...
					<table id="eir_pleintbl" class="datatableexport table card-table table-vcenter">	
                      ...
                      <?php $count=1;
                        ...
                        <tr>
                           ...
                           <td> <?php echo output($eir_pleins['t_num_facture']);?></td>
                           <td> <?php echo output($eir_pleins['pr_numero']);?></td>
                           <td> <?php echo output($eir_pleins['pr_numero']);?><?= (isset($eir_pleins['conteneur']->co_numero_conteneur))?$eir_pleins['conteneur']->co_numero_conteneur:'<span class="badge badge-danger">Non renseigné</span>'; ?></td>
                           <td> <?php //echo output($eir_pleins['mi_numero']);?></td>                           
							<td> <?php echo output($eir_pleins['ei_mission_id']);?></td>
