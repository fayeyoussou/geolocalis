            ...
            <div class="card">
              <div class="card-header p-2">
                ...
                <li class="nav-item"><a class="nav-link" href="#eir_vide" data-toggle="tab">EIR VIDE</a></li>
                 <li class="nav-item"><a class="nav-link" href="#demande_annulation" data-toggle="tab">DEMANDE ANNULATION</a></li><!---->
               </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
...
<!-- debut demande annulation -->					
<div class="tab-pane active" id="demande_annulation">
                    <table class="table table-sm table-bordered">
                  <tbody>
                    <tr>
                      <td>Motif de la demande </td>
                      <td><?= output($demande_annulation['mo_id']); ?></td>
                    </tr>
                    <tr>
                      <td>Statut</td>
                      <td><?//= output($missiondetails['mi_isactive']) ?><span class="badge <?php echo ($missiondetails['mi_isactive']=='1') ? 'badge-success' : 'badge-danger'; ?> "><?php echo ($missiondetails['mi_isactive']=='1') ? 'Plein' : 'Vide'; ?></span> </td>
