...
<div class="wrapper">
  ...
  <section class="col-12" class="invoice">
    ...
    <div class="row invoice-info">
      ...
      <!-- /.col -->
      <div class="col-sm-4 invoice-col">
        <b>trip #<?= output($data['s_inovice_prefix']).date('Ym').$tripdetails['t_id']; ?></b><br>
        <br>
        <b>N° d'ordre:</b> <?= output($tripdetails['t_id']) ?><br>
      ...
      <div class="col-12 table-responsive">
        <table class="table table-striped">
          ...
          <tr>
            ...
            <td>De  <br> <?= $tripdetails['t_trip_fromlocation']; ?> <br> à <br><?= $tripdetails['t_trip_tolocation']; ?> </td>
