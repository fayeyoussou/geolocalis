            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#reglement_factures" data-toggle="tab">Règlement factures </a></li>
                  <li class="nav-item"><a class="nav-link" href="#caisse" data-toggle="tab">Caisse</a></li>
...
<!--Debut transport-->               
                    <div class="active tab-pane" id="reglement_factures">
            ...
            <div class="card card-primary card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="reglement_factures-cheque-tab" data-toggle="pill" href="#reglement_factures-cheque" role="tab" aria-controls="reglement_factures-cheque" aria-selected="true">CHEQUE</a>
                  </li>
                  <li class="nav-item">
              ...
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="reglement_factures-cheque" role="tabpanel" aria-labelledby="reglement_factures-cheque-tab">
...
<section class="content">
      <div class="container-fluid">
       	     <form method="post" id="Income_Expense" class="card" action="<?php echo base_url();?>Incomexpense/<?php echo (isset($incomexpensedetails))?'updateincomexpense':'insertincomexpense_reglementfacture_cheque2'; ?>">
          <div class="card-body">
...
<section class="content">
      <div class="container-fluid">
       	     <form method="post" id="Income_Expense" class="card" action="<?php echo base_url();?>Incomexpense/<?php echo (isset($incomexpensedetails))?'updateincomexpense':'insertincomexpense_caisse_alimentationcaisse_espece2'; ?>">
          <div class="card-body">
...
<!--                  <li class="pt-2 px-3"><h3 class="card-title">Card Title</h3></li>
-->                  <li class="nav-item">
                    <a class="nav-link active" id="insertincomexpense_banque-entree-tab" data-toggle="pill" href="#insertincomexpense_banque-entree" role="tab" aria-controls="insertincomexpense_banque-entree" aria-selected="true">Entrée</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="insertincomexpense_banque-sortie-tab" data-toggle="pill" href="#insertincomexpense_banque-sortie" role="tab" aria-controls="insertincomexpense_banque-sortie" aria-selected="false">Sortie</a>
                  </li>
              ...
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="insertincomexpense_banque-entree" role="tabpanel" aria-labelledby="insertincomexpense_banque-entree-tab">
...
<!-- FIN BANQUE ENTREE-->
                  ...
                  <div class="tab-pane fade" id="insertincomexpense_banque-sortie" role="tabpanel" aria-labelledby="insertincomexpense_banque-sortie-tab">
