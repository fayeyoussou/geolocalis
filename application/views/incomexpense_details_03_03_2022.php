...
-->                      <th>#</th>
                  ...
                  <tbody>
                     <?php
                      ...
                      <td><?php echo output($paiementreglementdetails['tp_trip_id']); ?></td>
                      <!--<td><?php //if(isset($paiementreglementdetails['tp_type'])){echo output($paiementreglementdetails['tp_type']);}?></td>-->
                      <td><?php echo output($paiementreglementdetails['tp_amount']); ?> FCFA
                          ...
                          <?php //if(isset($conteneurdetails['co_type_conteneur'])){$type=$conteneurdetails['co_type_conteneur']; ?><?php //if($type=='20_pieds'){ echo "20 pieds";} else {echo "40 pieds";} ?><?php //} ?></td>
                      <td><?php echo output($paiementreglementdetails['tp_type']); ?><?php //if(isset($conteneurdetails['zone_name']->z_destination)){echo output($conteneurdetails['zone_name']->z_destination) ;} ?> <?php //if(isset($conteneurdetails['co_adresse_livraison'])){?> - <?php //echo output($conteneurdetails['co_adresse_livraison']) ;} ?></td>
                      <td><?php echo output($paiementreglementdetails['tp_amount']); ?></td>
                     <td>
                        
                         
 <a class="icon" href="<?php echo base_url(); ?>facture/conteneurfacture_delete/<?php //echo output($paiementreglementdetails['co_id']); ?>/<?= $incomexpensedetails['ie_id']; ?>"><i class="fa fa-trash text-danger"></i>
</a>                      

                         
                         
               <a href="<?php echo base_url(); ?>facture/conteneurfacture_edit/<?php //echo output($paiementreglementdetails['co_id']); ?>/<?= $incomexpensedetails['ie_id']; ?>" class="btn btn-sm btn-success" data-toggle="modal" data-target="#modal-import">M </a>                          
                          </td>
                    </tr>
                    <?php
...
-->                
              ...
              <div class="text-muted">
                ...
                <p class="text-sm">Informations Banque
                 <?php  if($incomexpensedetails['ie_espece_cheque']=="CHEQUE") {?> <b class="d-block">Banque émettrice: <?//= $banquedetails['ieb_name']; ?></b><?php }?>
                  <b class="d-block">Banque receptrice: <?//= $banquedetails['ieb_name']; ?></b>
                </p>                  
