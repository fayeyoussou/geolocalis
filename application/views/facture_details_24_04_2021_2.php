...
<!-- debut numéro conteneur--> 
            ...
            <div class="post clearfix">
                      <?php if(!empty($trip_conteneurdetails)) { ?>
                  ...
                  <tbody>
                     <?php $count=1;
                           foreach($trip_conteneurdetails as $trip_conteneurdetails){ ?>
                      <tr>
                      <td><?php echo output($count); $count++; ?></td>
                      <td><?php echo output($trip_conteneurdetails['co_numero_conteneur']); ?></td>
                      <td><?php echo output($trip_conteneurdetails['co_description']); ?></td>
                      <td><?php echo output($trip_conteneurdetails['co_created_date']); ?></td>
                      <td>
                        <a class="icon" href="<?php echo base_url(); ?>facture/facturepayment_delete/<?php echo output($trip_conteneurdetails['tp_id']); ?>/<?= $facturedetails['t_id']; ?>"><i class="fa fa-trash text-danger"></i></a>
                      </td>
                    </tr>
                    <?php } ?>
                  </tbody>
...
<div class="modal fade show" id="modal-factureexpense" aria-modal="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Ajouter des frais de facture</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
...
<div class="modal fade show" id="modal-conteneur" aria-modal="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Ajouter les factures</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
      <div class="modal-body">
        <form class="form-horizontal" id="addfactureconteneur" action="<?= base_url() ?>facture/addfactureconteneur" method="post">
                <div class="card-body">
                 ...
                 <input type="text" class="form-control" value="<?= $facturedetails['t_start_date']; ?>" name="co_created_date" id="co_created_date">
...
<!--                 <input type="text" class="form-control" value="expense" name="ie_type" id="ie_type">-->
                 <input type="text" class="form-control" value="<?= $facturedetails['t_id']; ?>" name="co_trip_id" id="co_trip_id">
        <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-default" data-dismiss="modal">Fermer</button>
        <button type="submit" class="btn btn-primary">Enregistrer dépenses</button>
      </div>
