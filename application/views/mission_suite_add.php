	...
	<div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label"> Pregate<span class="form-required">*</span></label>
					  ...
					  <input required type="text" name="mi_trip_id" id="mi_trip_id"  value="<?php //echo $missionsuite[0]['pregate']->pr_numero;?><?= (isset($missionsuite[0]['pregate']->pr_numero))?$missionsuite[0]['pregate']->pr_numero:'Non renseigné'; ?>" class="form-control" readonly >			 					  
                  </div>
               </div>					  
...
<input required type="text" name="mi_conteneur_id" id="mi_conteneur_id"  value="<?= (isset($missionsuite[0]['mi_conteneur_id']))?join_multi_select($missionsuite[0]['mi_conteneur_id'], 'trip_conteneur', 'co_id', 'co_numero_conteneur'):'Non renseigné'; ?>" class="form-control" readonly>					  
...
<input required type="text" name="mi_type_mission" id="mi_type_mission"  value="<?php echo $missionsuite[0]['mi_type_mission'];?>" class="form-control" readonly>					  
