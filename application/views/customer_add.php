    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?php echo (isset($customerdetails))?'Modifier Client':'Ajouter Client' ?> <?php if((isset($customerdetails))){ ?>    N°  <?php echo (isset($customerdetails)) ? $customerdetails[0]['c_num_customer']:'' ?>  <?php }else{?> N° 41100<?= $numerocustomer; }?>
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url(); ?>/dashboard">Clients</a></li>
              <li class="breadcrumb-item active"><?php echo (isset($customerdetails))?'Modifier Client':'Ajouter Client' ?><?php if((isset($customerdetails))){ ?>    N°  <?php echo (isset($customerdetails)) ? $customerdetails[0]['c_num_customer']:'' ?>  <?php }else{?> N° 41100<?= $numerocustomer; }?> </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<?php if((isset($customerdetails))){}else{ ?>
          <input type="hidden" id="c_num_customer" name="c_num_customer" value="41100<?= $numerocustomer; ?>">
<?php } ?>              
