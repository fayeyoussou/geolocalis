            ...
            <div class="card card-primary card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-conteneur-tab" data-toggle="pill" href="#custom-tabs-conteneur" role="tab" aria-controls="custom-tabs-one-home" aria-selected="true">Conteneurs</a>
                  </li>
                  <li class="nav-item">
...
<?php /**/ $montant_conteneur = $conteneurdetails['zone_name']->z_montant_conteneur_20;
                      ...
                      <td><?php echo $montant_conteneur; ?> - <?php  echo $montanttotal_conteneur += $montant_conteneur;?></td>
                     <td>
