            ...
            <li class="nav-item has-treeview <?php echo ((activate_menu('incomexpense'))=='active') ? 'menu-open':'' ?>
               ...
               <ul class="nav nav-treeview">
                 <?php  if(userpermission('lr_ie_list')) { ?>
                  ...
                  <li class="nav-item">
                     <a href="<?= base_url(); ?>incomexpense/addreglement_facture" class="nav-link <?php echo activate_menu('addreglement_facture');?>">
                        <i class="nav-icon fas faa-plus"></i>
                  ...
                  <?php } ?>
                   ...
                   <?php  if(userpermission('lr_ie_add')) { ?>
                  <li class="nav-item">
                     <a href="<?= base_url(); ?>incomexpense/addcaisse" class="nav-link <?php echo activate_menu('addcaisse');?>">
                        <i class="nav-icon fas faa-plus"></i>
                        <p>Ajouter caisse</p>
                     </a>
                  </li>
                  <?php } ?>
                   ...
                   <?php  if(userpermission('lr_ie_add')) { ?>
                  <li class="nav-item">
                     <a href="<?= base_url(); ?>incomexpense/addbanque" class="nav-link <?php echo activate_menu('addbanque');?>">
                        <i class="nav-icon fas faa-plus"></i>
                        <p>Ajouter banque</p>
                     </a>
                  </li>
