...
<!--Debut comptabilité-->
           <?php   if(userpermission('lr_ie_list') || userpermission('lr_ie_add')) { ?>
            <li class="nav-item has-treeview <?php echo ((activate_menu('incomexpense'))=='active') ? 'menu-open':'' ?>
               <?php echo ((activate_menu('addincomexpense'))=='active') ? 'menu-open':'' ?><?php echo ((activate_menu('editincomexpense'))=='active') ? 'menu-open':'' ?><?php echo ((activate_menu('journal_facture'))=='active') ? 'menu-open':'' ?>">
                 ...
                 <?php  if(userpermission('lr_ie_list')) { ?>
                  <li class="nav-item">
                     <a href="<?= base_url(); ?>incomexpense" class="nav-link <?php echo activate_menu('incomexpense');?> <?php echo activate_menu('editincomexpense');?>">
                        <i class="nav-icon fas faa-list"></i>
                        <p>Opération de caisses</p>
                     </a>
                  </li>
				    <?php } ?>
                   <?php  if(userpermission('lr_ie_add')) { ?>
                  <li class="nav-item">
                     <a href="<?= base_url(); ?>incomexpense/reglement_facture" class="nav-link <?php echo activate_menu('reglement_facture');?>">
                        <i class="nav-icon fas faa-plus"></i>
                        <p>Ajouter un reglement</p>
                     </a>
                  </li>
                  <?php } ?>
                   ...
                   <?php  if(userpermission('lr_ie_add')) { ?>
                  <li class="nav-item">
                     <a href="<?= base_url(); ?>incomexpense/caisse" class="nav-link <?php echo activate_menu('caisse');?>">
                        <i class="nav-icon fas faa-plus"></i>
                        <p>Ajouter caisse</p>
                     </a>
                  </li>
                  <?php } ?>
                   ...
                   <?php  if(userpermission('lr_ie_add')) { ?>
                  <li class="nav-item">
                     <a href="<?= base_url(); ?>incomexpense/banque" class="nav-link <?php echo activate_menu('banque');?>">
                        <i class="nav-icon fas faa-plus"></i>
                        <p>Ajouter caisse</p>
                     </a>
                  </li>
                  ...
                  <li class="nav-item">
                     <a href="<?= base_url(); ?>incomexpense/addincomexpense" class="nav-link <?php echo activate_menu('addincomexpense');?>">
                        <i class="nav-icon fas faa-plus"></i>
                        <p>Ajouter une opération de caisse</p>
                     </a>
                  </li>
                  <?php } ?>
                  ...
                  <li class="nav-item">
                   ...
                   <li class="nav-item">
                     <a href="<?= base_url(); ?>incomexpense/journal_facture" class="nav-link <?php echo activate_menu('incomexpense');?>">
                        <i class="nav-icon fas faa-plus"></i>
                        <p>Journal des réglements de factures</p>
                     </a>
                  </li>				   
