        ...
        <div class="card card-primary card-tabs">
          <div class="card-header p-0 pt-1">
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill" href="#custom-tabs-one-home" role="tab" aria-controls="custom-tabs-one-home" aria-selected="true">DEMANDE ANNULATION MISSION</a>
              </li>
          ...
          <div class="card-body">
            <div class="tab-content" id="custom-tabs-one-tabContent">
              <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
       	     ...
       	     <form method="post" id="mission" class="card" action="<?php echo base_url();?>mission/<?php echo (isset($missiondetails))?'insertdemandeannulationmission':'insertmission'; ?>">
          <div class="card-body">
...
<div class="col-sm-6 col-md-3">
              ...
              <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" name="mi_quantite_carburant" id="mi_quantite_carburant"  value="<?php echo (isset($missiondetails)) ? $missiondetails[0]['mi_quantite_carburant']:'' ?>" class="form-control" placeholder="Quantité carburant">
                  </div>
               </div> 					  
	 ...
	 <div class="row">		  
			  <div class="col-sm-6 col-md-4">
                  <div class="form-group">
                     ...
                     <select id="mo_motif_id" class="form-control selectized" name="mo_motif_id" >
			  ...
			  <div class="col-sm-6 col-md-8">
                      <div class="form-group">
                       <label class="form-label">Description de la demande d'annulation</label>
                          <input type="text" class="form-control" id="mo_desc" value="<?php //echo (isset($missiondetails)) ? $missiondetails[0]['mo_desc']:'' ?>" name="mo_desc" placeholder="Description">
                      </div>
                    </div>
		  </div>
...
<!--                 <input type="hidden" id="mi_trip_id" name="mi_trip_id" value="<?//= $this->uri->segment(3); ?>">
                  ...
                  <button type="submit" class="btn btn-primary"> <?php echo (isset($missiondetails))?'Demande annulation mission':'Ajouter mission' ?></button>
      </div>
    </form>	
