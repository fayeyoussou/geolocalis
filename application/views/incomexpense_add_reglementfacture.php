    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-7">
            <h1 class="m-0 text-dark"><?php echo (isset($incomexpensedetails))?'Modifier mouvement de caisse':'Ajouter un reglement de facture' ?> <?php if((isset($incomexpensedetails))){ ?>    N°  <?php echo (isset($incomexpensedetails)) ? $incomexpensedetails[0]['ie_numero_enregistrement']:'' ?>  <?php }else{?> N° R<?= $numeroreglement; }?>
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-5">
...
<section class="content">
      <div class="container-fluid">
       	     <form method="post" id="Income_Expense" class="card" action="<?php echo base_url();?>Incomexpense/<?php echo (isset($incomexpensedetails))?'updatereglement':'insertincomexpense_reglementfacture_cheque'; ?>">
          <div class="card-body">
                  ...
                  <div class="row">
                   <input type="hidden" name="ie_id" id="ie_id" value="<?php echo (isset($incomexpensedetails)) ? $incomexpensedetails[0]['ie_id']:'' ?>" >
					...
					<div class="col-sm-6 col-md-4">
                     ...
                     <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                         <label class="form-label">Montant chéque<span class="form-required">*</span></label>
                          <input type="text" class="form-control" id="ie_amount" value="<?php echo (isset($incomexpensedetails)) ? $incomexpensedetails[0]['ie_amount']:'' ?>" name="ie_amount" placeholder="Montant chéque">
                      </div>
                    </div>        
					...
					<div class="col-sm-6 col-md-4">
                      <div class="form-group">
                         <label class="form-label">Montant ristourne<span class="form-required">*</span></label>
                          <input type="text" class="form-control" id="ie_amount_ristourne" value="<?php echo (isset($incomexpensedetails)) ? $incomexpensedetails[0]['ie_amount_ristourne']:'' ?>" name="ie_amount_ristourne" placeholder="Montant ristourne">
                      </div>
                    </div>					  
 ...
 <!--<div class="col-sm-6 col-md-4">
                  <div class="form-group">
					...
					<div class="col-sm-6 col-md-4">
                     ...
                     <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                         <label class="form-label">Montant caisse<span class="form-required">*</span></label>
                          <input type="text" class="form-control" id="ie_amount" value="<?php echo (isset($incomexpensedetails)) ? $incomexpensedetails[0]['ie_amount']:'' ?>" name="ie_amount" placeholder="Montant caisse">
                      </div>
                    </div>       
...
<!---->                           <td><?php echo output($incomexpenses['ie_numero_enregistrement']); ?></td>
                        ...
                        <td> <?php if((isset($incomexpenses['tra_name'])) !=''){  echo output($incomexpenses['tra_name']);} ?></td>
