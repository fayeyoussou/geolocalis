<?php if((isset($facturedetails))){
	$url = $this->uri->segment(2);//exit;
}?>
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?php echo (isset($facturedetails))?'Modifier la proforma':'Ajouter proforma' ?><?php if((isset($facturedetails))){ ?>    N°  <?php echo (isset($facturedetails)) ? $facturedetails[0]['t_num_proforma']:'' ?>  <?php }else{?> N°
                PRO000<?= $numeroproforma; }?> 
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url(); ?>/dashboard">Proforma</a></li>
              <li class="breadcrumb-item active"><?php echo (isset($facturedetails))?'Modifier Proforma':'Ajouter Proforma' ?> </li>      
    ...
    <!-- Main content -->
<?php if((isset($facturedetails))){
//	echo $url = $this->uri->segment(2);//exit;
//}?>
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                   <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Transport") && ($url == "editfacture_proforma")){	?> 
					<li class="nav-item"><a class="nav-link active" href="#transport" data-toggle="tab">Transport</a></li> <?php }?> 
                     <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Exportation") && ($url == "editfacture_proforma")){	?>
					<li class="nav-item"><a class="nav-link active" href="#exportation" data-toggle="tab">Exportation</a></li> <?php }?> 
                     <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Transfert") && ($url == "editfacture_proforma")){	?>
					<li class="nav-item"><a class="nav-link active" href="#transfert" data-toggle="tab">Transfert</a></li> <?php }?> 
                 <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Immobilisation") && ($url == "editfacture_proforma")){	?>
					<li class="nav-item"><a class="nav-link active" href="#immobilisation" data-toggle="tab">Immobilisation</a></li> <?php }?> 
                     <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Manutentation") && ($url == "editfacture_proforma")){	?> <li class="nav-item"><a class="nav-link active" href="#manutentation" data-toggle="tab">Manutentation</a></li> <?php }?> 
					
    <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Detention") && ($url == "editfacture_proforma")){	?>
<li class="nav-item"><a class="nav-link active" href="#detention" data-toggle="tab">Détention</a></li>  <?php }?>  
    <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Forfait") && ($url == "editfacture_proforma")){	?>					
                  <li class="nav-item"><a class="nav-link active" href="#forfait" data-toggle="tab">Forfait</a></li> <?php }?>
				</ul>
              </div><!-- /.card-header -->
              <div class="card-body">
...
<!--Debut transport-->               
    <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Transport") && ($url == "editfacture_proforma")){	?>					
                    <div class="active tab-pane" id="transport">                    <div class="post">
...
<?php if((isset($facturedetails))){}else{ ?>
          <input type="hidden" id="t_num_proforma" name="t_num_proforma" value="PRO000<?= $numeroproforma; ?>">
          <input type="hidden" id="t_modele_facture" name="t_modele_facture" value="PROFORMA">                               
<?php } ?>
 ...
 <!--Debut transport-->               
                    ...
                    <!-- /.tab-pane -->
<?php } // End controle transport?>
 <!--Debut transport-->               
                    <!-- /.tab-pane -->
					
    <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Exportation") && ($url == "editfacture_proforma")){	?>					
                  <div class="active tab-pane" id="exportation">                    <!-- The timeline -->
<div class="post">
                      <div class="user-block">
<!--exportation-->
                          <form method="post" id="facture_add" class="card"  action="<?php echo base_url();?>facture/<?php echo (isset($facturedetails))?'updatefacture':'insertfacture'; ?>">
...
<?php }// end controle exportation?>					
    <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Transfert") && ($url == "editfacture_proforma")){	?>
                  <div class="active tab-pane" id="transfert"><div class="post">
                      <div class="user-block">
transfert
                          <form method="post" id="facture_add" class="card"  action="<?php echo base_url();?>facture/<?php echo (isset($facturedetails))?'updatefacture':'insertfacture'; ?>">
            <div class="row">
...
<?php } ?>
  ...
  <?php }// end controle exportation?>					
    <?php if((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Immobilisation"){	?>                  
                  <div class="active tab-pane" id="immobilisation">
					  <div class="post">
                      <div class="user-block">
immobilisation
                          <form method="post" id="facture_add" class="card"  action="<?php echo base_url();?>facture/<?php echo (isset($facturedetails))?'updatefacture':'insertfacture'; ?>">
...
<?php } ?>
            ...
            <input type="hidden" id="t_created_date" name="t_created_date" value="<?php echo date('Y-m-d h:i:s'); ?>">
            <div class="card-footer text-right">
               <button type="submit" class="btn btn-primary"> <?php echo (isset($facturedetails))?'Modifier facture':'Ajouter facture Immobilisation' ?></button>
            </div>
      </form>
                  ...
                  <!-- /.tab-pane -->
<?php }// end controle exportation?>					
    <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Manutentation") && ($url == "editfacture_proforma")){	?>
					
                  <!-- /.tab-pane -->
                  <div class="active tab-pane" id="manutentation">                    <!-- The timeline -->
<div class="post">
                      <div class="user-block">
manutentation
                          <form method="post" id="facture_add" class="card"  action="<?php echo base_url();?>facture/<?php echo (isset($facturedetails))?'updatefacture':'insertfacture'; ?>">
...
<?php if((isset($facturedetails))){}else{ ?>
          ...
          <input type="hidden" id="t_modele_facture" name="t_modele_facture" value="PROFORMA">                               
<?php } ?>
          <input type="hidden" id="cpt_numero" name="cpt_numero" value="<?= $numeroproforma; ?>">                              
            ...
            <input type="hidden" id="t_created_date" name="t_created_date" value="<?php echo date('Y-m-d h:i:s'); ?>">
            <div class="card-footer text-right">
               <button type="submit" class="btn btn-primary"> <?php echo (isset($facturedetails))?'Modifier facture':'Ajouter facture Manutention' ?></button>
            </div>
      </form>
...
<?php }// end controle exportation?>					
    <?php if((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Detention"){	?>					
					
                  <div class="active tab-pane" id="detention">                    <div class="post">
                      <div class="user-block">
...
<?php } ?>
            ...
            <input type="hidden" id="t_created_date" name="t_created_date" value="<?php echo date('Y-m-d h:i:s'); ?>">
            <div class="card-footer text-right">
               <button type="submit" class="btn btn-primary"> <?php echo (isset($facturedetails))?'Modifier facture':'Ajouter facture Detention' ?></button>
            </div>
      </form>
 ...
 <?php }// end controle exportation?>					
    <?php if((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Forfait"){	?>
...
<?php } ?>
            ...
            <input type="hidden" id="t_created_date" name="t_created_date" value="<?php echo date('Y-m-d h:i:s'); ?>">
            <div class="card-footer text-right">
               <button type="submit" class="btn btn-primary"> <?php echo (isset($facturedetails))?'Modifier facture':'Ajouter facture Forfait' ?></button>
            </div>
      </form>
