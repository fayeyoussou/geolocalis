         ...
         <div class="card-body">
            <div class="row">
               ...
               <div class="col-sm-6 col-md-3">
                  <label class="form-label">Client ok<span class="form-required">*</span></label>
                   ...
                   <div class="form-group">
                     ...
                     <select id="t_transitaire"  class="form-control"  name="t_transitaire">
                       <option value="">Selectionner le transitaire</option>
                        ...
                        <option <?php if((isset($facturedetails)) && $facturedetails[0]['t_transitaire'] == $transitairelists['t_id']){ echo 'selected';} ?> value="<?php echo output($transitairelists['t_id']) ?>"><?php echo output($transitairelists['t_name']); ?> </option>
                        <?php  } ?>
                     </select>
                  </div>
              </div>
               ...
               <!--<div class="col-sm-6 col-md-3">
                ...
                <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_num_conteneur']:'' ?>" name="t_num_conteneur" value="" class="form-control" placeholder="Numéro conteneur">
                  </div>
               </div>                
                <!--Fin Numéro-->  
  ...
  <!-- debut nature-->                
               ...
               <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_date_facture']:'' ?>" name="t_date_facture" value="" class="form-control datepicker" placeholder="Date facture">
                  </div>
               </div>
                ...
                <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_trip_amount']:'' ?>" name="t_trip_amount" value="" class="form-control" placeholder="Montant total de la facture">
                  </div>
               </div>
                  ...
                  <div class="form-group">
                     ...
                     <select id="t_driver"  class="form-control"  name="t_driver">
                       <option value="">Selectionner chauffeur</option>
                        ...
                        <option <?php if((isset($facturedetails)) && $facturedetails[0]['t_driver'] == $driverlists['d_id']){ echo 'selected';} ?> value="<?php echo output($driverlists['d_id']) ?>"><?php echo output($driverlists['d_name']); ?></option>
                        <?php  } ?>
                     </select>
                  </div>
               </div>
...
<!-- Debut Carte Carburant--> 
                   ...
                   <div class="form-group">
                     ...
                     <select id="t_carte_carburant"  class="form-control"  name="t_carte_carburant">
                       <option value="">Selectionner la Carte carburant</option>
                        ...
                        <option <?php if((isset($facturedetails)) && $facturedetails[0]['t_carte_carburant'] == $carte_carburantlists['cc_id']){ echo 'selected';} ?> value="<?php echo output($carte_carburantlists['cc_id']) ?>"><?php echo output($carte_carburantlists['cc_name']).' - '. output($carte_carburantlists['cc_numero']);  ?> </option>
                        <?php  } ?>
                     </select>
                  </div>
              </div>
            ...
            <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_carte_carburant_amount']:'' ?>" name="t_carte_carburant_amount" id="t_carte_carburant_amount" class="form-control" placeholder="Montant carburant">
                  </div>
               </div>                
            ...
            <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_carte_carburant_quantite']:'' ?>" name="t_carte_carburant_quantite" id="t_carte_carburant_quantite" class="form-control" placeholder="Montant carburant">
                  </div>
               </div>
               ...
               <div class="col-sm-6 col-md-3">
                   <div class="form-group">
                     ...
                     <select id="t_carte_peage"  class="form-control"  name="t_carte_peage">
                       <option value="">Selectionner la Carte carburant</option>
                        ...
                        <option <?php if((isset($facturedetails)) && $facturedetails[0]['t_carte_peage'] == $carte_peagelists['cp_id']){ echo 'selected';} ?> value="<?php echo output($carte_peagelists['cp_id']) ?>"><?php echo output($carte_peagelists['cp_name']).' - '. output($carte_peagelists['cp_numero']);  ?> </option>
                        <?php  } ?>
                     </select>
                  </div>
              </div>
                ...
                <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_carte_peage_amount']:'' ?>" name="t_carte_peage_amount" id="t_carte_carburant_quantite" class="form-control" placeholder="Montant péage">
                  </div>
               </div>                
...
<!--DEBUT PREGATE-->                
                <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_date_pregate']:'' ?>" name="t_date_pregate" value="" class="form-control datepicker" placeholder="Date Pré gate">
                  </div>
               </div>                
<!-- FIN PREGATE-->   
            ...
            <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <select id="t_vechicle"  class="form-control"  name="t_vechicle" >
                        ...
                        <option <?php if((isset($facturedetails)) && $facturedetails[0]['t_vechicle'] == $vechiclelists['v_id']){ echo 'selected';} ?> value="<?php echo output($vechiclelists['v_id']) ?>"><?php echo output($vechiclelists['v_name']).' - '. output($vechiclelists['v_registration_no']); ?></option>
                        <?php  } ?>
                     </select>
                  </div>
               </div>                
                ...
                <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <select id="t_vehicle_remorque"  class="form-control"  name="t_vehicle_remorque" >
                        <option value="">Sélectionner Véhicule</option>
                        <?php  foreach ($vehicleremorquelist as $key => $vehicleremorquelists) { ?>
                        <option <?php if((isset($facturedetails)) && $facturedetails[0]['t_vehicle_remorque'] == $vehicleremorquelists['vr_id']){ echo 'selected';} ?> value="<?php echo output($vehicleremorquelists['vr_id']) ?>"><?php echo output($vehicleremorquelists['vr_name']).' - '. output($vehicleremorquelists['vr_numero_immatriculation']); ?></option>
                        <?php  } ?>
                     </select>
                  </div>
               </div>                
                ...
                <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_date_line']:'' ?>" name="t_date_line" value="" class="form-control datepicker" placeholder="Date line">
                  </div>
               </div>                
                <!-- FIN Date line--> 
                ...
                <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_eir_plein']:'' ?>" name="t_eir_plein" value="" class="form-control datepicker" placeholder="Date EIR plein">
                  </div>
               </div>                
                <!-- FIN Date line--> 
                ...
                <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_eir_vide']:'' ?>" name="t_eir_vide" value="" class="form-control datepicker" placeholder="Date EIR vide">
                  </div>
               </div>                
                <!-- FIN Date line-->                 
