    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?php echo (isset($customerdetails))?'Modifier Client':'Ajouter Client' ?>
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url(); ?>/dashboard">Clients</a></li>
              <li class="breadcrumb-item active"><?php echo (isset($customerdetails))?'Modifier Client':'Ajouter Client' ?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                    ...
                    <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         <label class="form-label">Portable<span class="form-required">*</span></label>
                          <input type="text" required="false" class="form-control" value="<?php echo (isset($customerdetails)) ? $customerdetails[0]['c_mobile']:'' ?>" id="c_mobile" name="c_mobile" placeholder="Customer Mobile">
                      </div>
                    </div>
