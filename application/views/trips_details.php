    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Détails de la trip
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url(); ?>/dashboard">Tableau de bord</a></li>
              <li class="breadcrumb-item active">Détails de la trip et du voyage</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12 col-md-12 col-lg-8 order-2 order-md-1">
              <div class="row">
                ...
                <div class="col-12 col-sm-4">
                  <div class="info-box bg-light">
                    <div class="info-box-content">
                      <span class="info-box-text text-center text-muted"><?= ($tripdetails['t_trip_amount'] > $totalpaidamt)?'Restant':'Excès' ?></span>
                ...
                <div class="col-12">
                     ...
                     <div class="col-lg-5">
                      <div class="user-block">
                        ...
                        if($tripdetails['t_totaldistance']!='') {
                          ...
                          <?= $tripdetails['t_type']; ?> avec total <?= $dist; ?> km 
                        <?php } ?>
                     </div>
                    </div>
                  ...
                  <tbody>
                     <?php $count=1;
                      ...
                      <td>
                        <a class="icon" href="<?php echo base_url(); ?>trip/trippayment_delete/<?php echo output($paymentdetails['tp_id']); ?>/<?= $tripdetails['t_id']; ?>"><i class="fa fa-trash text-danger"></i></a>
                      </td>
                    </tr>
                    <?php } ?>
                  </tbody>
            ...
            <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
              <div class="mt-2 mb-3">
                <a href="#" class="btn btn-sm btn-success <?= ($tripdetails['t_trip_amount'] - $totalpaidamt==0)?'disabled':'' ?>" data-toggle="modal" data-target="#modal-AddPayment">Ajouter un paiement</a>
                <a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#modal-tripexpense">Dépenses</a>
                <a href="<?= base_url(); ?>trip/invoice/<?= $tripdetails['t_id']; ?>" target="_blank" class="btn btn-sm btn-success" >Générer trip</a>

<!--                <a href="<?//= base_url(); ?>trip/invoice/<?//= $tripdetails['t_id']; ?>" target="_blank" class="btn btn-sm btn-success" >Generate Invoice</a>
-->                
              ...
              <div class="text-muted">
                ...
                <p><div class="col-6"><a href="<?= base_url() ?>trip/sendtracking?email=<?= urlencode($customerdetails['c_email']); ?>&trackingcode=<?= $tripdetails['t_trackingcode'] ?>&t_id=<?= $tripdetails['t_id'] ?>" class="btn btn-sm btn-success">Partager avec le client</a></div></p>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="trippayments" action="<?= base_url() ?>trip/trippayment" method="post">
                <div class="card-body">
                  <div class="form-group row">
                    <label for="totalamount" class="col-sm-4 col-form-label">Montant Total</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" name="totalamount" value="<?= $tripdetails['t_trip_amount']; ?>" id="totalamount" placeholder="Saisir Montant Total" disabled>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="paidamount" class="col-sm-4 col-form-label">Montant  restant</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="pendingamount" value="<?= $tripdetails['t_trip_amount']-$totalpaidamt; ?>" id="pendingamount" placeholder="Montant restant" disabled>
                    </div>
                  </div>
                  <div class="form-group row">
...
<div class="modal fade show" id="modal-tripexpense" aria-modal="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Ajouter des frais de trip</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
      <div class="modal-body">
        <form class="form-horizontal" id="addtripexpense" action="<?= base_url() ?>trip/addtripexpense" method="post">
                <div class="card-body">
                  <div class="form-group row">
