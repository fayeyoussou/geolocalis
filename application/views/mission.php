    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Informations sur les Missions
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url(); ?>/dashboard">Tableau de bord</a></li>
              <li class="breadcrumb-item active">Informations sur les Missions</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                    ...
                    <table id="missiontbl" class="table card-table">
                      ...
                      <?php $count=1;
                        ...
                        <tr>
                           ...
                           <td> <?php echo output($missions['pr_trip_id']); ?><?php //echo output($missions['vech_name']->v_name).'_'.output($missions['vech_name']->v_registration_no); ?></td>
                         ...
                         <td><?php echo output($missions['pr_date_line']); ?></td>
                          ...
                          <?php if(userpermission('lr_pr_edit')) { ?>
                              <td>
                            <a class="icon" href="<?php echo base_url(); ?>mission/editmission/<?php echo output($missions['pr_id']); ?>">
                              <i class="fa fa-edit"></i>
                            </a>
							<?php  if(userpermission('lr_mi_add')) { ?>	  
								<a class="icon" href="<?php echo base_url(); ?>conteneur/mission/<?php echo output($missions['pr_trip_id']); ?>">
								  <i class="fa fa-eye"></i>
								</a>
							<?php } ?>
                          </td>
