          ...
          <div class="row">
            <div class="col-12 col-md-12 col-lg-8 order-2 order-md-1">
              <div class="row">
                ...
                <div class="col-12 col-sm-4">
                  <div class="info-box bg-light">
                    <div class="info-box-content">
                      <span class="info-box-text text-center text-muted"><?= ($tripdetails['t_trip_amount'] > $totalpaidamt)?'En attente':'Excess' ?></span>
                  ...
                  <h4>Aperçu:</h4>
                    <div class="post">
                      ...
                      <div class="user-block">
                        ...
                        <span class="description"><?= $tripdetails['t_date_facturation']; ?></span>
                      </div>
                    </div> à
                     <div class="col-lg-5">
                      <div class="user-block">
                        ...
                        <span class="description"><?= $tripdetails['t_line_date']; ?></span>
                      </div>
                       </div>
            ...
            <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
              <div class="mt-2 mb-3">
                ...
                <a href="<?= base_url(); ?>trips/invoice/<?= $tripdetails['t_id']; ?>" target="_blank" class="btn btn-sm btn-success" >Generez la facture</a>
              </div> 
              <br>
              <div class="text-muted">
                ...
                <p><div class="col-6"><a href="<?= base_url() ?>trips/sendtracking?email=<?= urlencode($customerdetails['c_email']); ?>&trackingcode=<?= $tripdetails['t_trackingcode'] ?>&t_id=<?= $tripdetails['t_id'] ?>" class="btn btn-sm btn-success">Partagez avec le client</a></div></p>
              </div>
            </div>
          </div>
        </div>
