...
<tr>
	...
	<td style="text-align:center;" height="'.$taille.'" width="90"><b>VEHICULE</b></td>
	<td style="text-align:center;" height="'.$taille.'" width="100"><b>CONDUCTEUR</b></td>
	<td style="text-align:center;" height="'.$taille.'" width="100"><b>STATION</b></td>
</tr>';
...
<td style="text-align:center;" height="'.$taille.'" width="80"><b>'.$row_bc['bc_numero'].'</b></td>
	...
	<td style="text-align:center;" height="'.$taille.'" width="90"><b>'.$row_bc['v_registration_no'].'</b></td>
	<td style="text-align:center;" height="'.$taille.'" width="100"><b>'.$row_bc['d_name'].'</b></td>
	<td style="text-align:center;" height="'.$taille.'" width="100"><b>'.$row_bc['ccc_name'].'</b></td>
