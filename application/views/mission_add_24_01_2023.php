          ...
          <?php if(!empty($mission)){ ?>
                    <table id="missiontbl" class="datatableexport table card-table table-vcenter">
                      ...
                      <?php $count=1;
                           ...
                           ?>
                        <tr>
                           <td> <?php echo output($count); $count++; ?></td>facture
                            <td> <?php //echo output($missions['t_num_facture']); ?><?php echo ucfirst($missions['facture']->t_num_facture); ?></td>
							<td> <?php //echo output($missions['t_num_facture']); ?><?php echo ucfirst($missions['facture']->t_num_facture); ?></td>
                            <td> <?php echo output($missions['mi_numero']); ?></td>
                          <td> <?php echo output($missions['mi_date_mission']); ?></td>
                           <td> <?php //echo output($missions['v_registration_no']); ?><?php echo ucfirst($missions['vehicule']->v_registration_no); ?></td>

                           <td><?php //echo output($missions['pr_numero']); ?><?php echo ucfirst($missions['pregate']->pr_numero); ?></td>
                         <td><?php //echo output($missions['co_numero_conteneur']); ?><?php echo ucfirst($missions['conteneur']->co_numero_conteneur); ?></td>
                         <td><?php //echo output($missions['clr_name']); ?><?php echo ucfirst($missions['lieu_restitution']->clr_name); ?></td>
                         <td><?php //echo output($missions['d_name']); ?><?php echo ucfirst($missions['conducteur']->d_name); ?></td>
