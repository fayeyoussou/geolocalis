            ...
            <div class="card-body">
               <div class="row">
                  ...
                  <div class="col-sm-6 col-md-4">
				   ...
				   <div class="col-sm-6 col-md-4">
                     <div class="form-group">
                        <label>Prime Permantent Bas</label>
                        <input type="text" class="form-control" required="true" value="<?php echo output(isset($website_setting[0]['s_driver_prime_permanent_bas'])?$website_setting[0]['s_driver_prime_permanent_bas']:''); ?>" id="s_driver_prime_permanent_bas" name="s_driver_prime_permanent_bas" placeholder="Prime Permantent Bas">
                     </div>
                  </div>
				   
				   <div class="col-sm-6 col-md-4">
                     <div class="form-group">
                        <label>Prime Permanent Elevé</label>
                        <input type="text" class="form-control" required="true" value="<?php echo output(isset($website_setting[0]['s_driver_prime_permanent_eleve'])?$website_setting[0]['s_driver_prime_permanent_eleve']:''); ?>" id="s_driver_prime_permanent_eleve" name="s_driver_prime_permanent_eleve" placeholder="Prime Permanent Elevé">
                     </div>
                  </div>				   

				   <div class="col-sm-6 col-md-4">
                     <div class="form-group">
                        <label>Prime Permanent Prestataire</label>
                        <input type="text" class="form-control" required="true" value="<?php echo output(isset($website_setting[0]['s_driver_prime_prestataire'])?$website_setting[0]['s_driver_prime_prestataire']:''); ?>" id="s_driver_prime_prestataire" name="s_driver_prime_prestataire" placeholder="Prime Permanent Prestataire">
                     </div>
                  </div>					   
