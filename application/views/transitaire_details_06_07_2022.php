...
<div class="form-group row">
				...
				<div class="form-group row">
                    ...
                    <div class="form-group col-sm-8">
                     <select id="ie_trip_id" class="form-control" style="width: 100%;"  name="ie_trip_id">
                        <option value="">Sélectionner la facture </option>
                        <?php  foreach ($facture_transitaire as $key => $facturelists) { ?>
                 ...
                 <input type="hidden" id="ie_created_date" name="ie_created_date" value="<?php echo date('Y-m-d h:i:s'); ?>">
                  ...
                  <input type="hidden" id="ie_ristourne_tva" name="ie_ristourne_tva" value="<?php echo "RISTOURNE"; ?>"><!--RISTOURNE-->			        
			  	  <input type="text" id="ie_numero_enregistrement" name="ie_numero_enregistrement" value="B<?= $numero_compteurbanque; ?>">	
			
			  	  <input type="text" id="ie_transitaire_id" name="ie_transitaire_id" value="<?= $transitairedetails['tra_id']; ?>	">	
