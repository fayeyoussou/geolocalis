...
<?php //echo (isset($fuel_carte_carburantdetails))?'MODIFIER BON CARBURANT':'AJOUTER BON CARBURANT' ?>
           <?php //if((isset($fuel_carte_carburantdetails))){ ?> N° <?php //echo (isset($fuel_carte_carburantdetails)) ? $fuel_carte_carburantdetails[0]['bc_numero']:'' ?>  <?php //}else{?> N° BC<?php // $numerobon_carburant; }?>				
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="card card-primary card-tabs">
          <div class="card-header p-0 pt-1">
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill" href="#custom-tabs-one-home" role="tab" aria-controls="custom-tabs-one-home" aria-selected="true"><?php echo (isset($fuel_carte_carburantdetails))?'Modifier bon de carburant':'AJOUTER UN BON DE CARBURANT' ?>N° BC<?= $numerobon_carburant; ?></a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" id="custom-tabs-one-paiement-tab" data-toggle="pill" href="#custom-tabs-one-paiement" role="tab" aria-controls="custom-tabs-one-paiement" aria-selected="false">DEMANDE DE PAIEMENT N° BP<?php echo $numerobon_carburant_payments; ?></a>
              </li>
            </ul>
          </div>
          <div class="card-body">
				...
				if(userpermission('lr_fuel_validation')) { 			   
                   ...
                   <?php } // fin controle?>
					 <?php }  // fin controle?>	
                      ...
                      <?php }else{  // fin controle?>
                        
<?php if(userpermission('lr_fuel_delete')) { ?>
                          <a class="icon" href="<?php echo base_url(); ?>fuel_bon_carburant/fuel_bon_carburant_delete/<?php echo output($fuels['bc_id']); ?>">
...
<!--END -->	                  
                 ...
                 <input type="hidden" id="ccrp_date" name="ccrp_date" value="<?php echo date('Y-m-d h:i:s'); ?>">
                   <input type="hidden" id="ccrp_numero" name="ccrp_numero" value="BP<?= $numerobon_carburant_payments; ?>">
      <div class="modal-footer">
...
-->                          <th>Validation</th>
                      ...
                      <?php if(!empty($fuel_bon_carburant_tab_paiement_list)){  $count=1;
                        ...
                        <tr>
                           ...
                           <td><?php echo output($paiement['ccrp_numero']); ?>

							   
<?php //echo join_multi_select($paiement['ccrp_bon_carburant_id'], 'fuel_bon_carburant', 'bc_id', 'bc_numero'); ?></td>
