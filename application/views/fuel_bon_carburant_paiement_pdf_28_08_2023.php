...
<tr>
	...
	<td style="text-align:center;" height="'.$taille.'" width="130"><b>N° BON :</b></td>
	<td height="'.$taille.'" width="150"><b>QUANTITE</b></td>
		<td style="text-align:left;" height="'.$taille.'" width="150"><b> DATE</b></td>
	<td style="text-align:center;" height="'.$taille.'" width="150"><b>VEHICULE</b></td>
</tr>';
...
//
$where = "";
$where = "bc_vehicule_id=v_id AND bc_id='$str'";	
	
		$query = $this->db->select('*')->from('fuel_bon_carburant,vehicles')->where($where)->order_by('bc_date','desc')->get()->result_array();
...
<td style="text-align:center;" height="'.$taille.'" width="130"><b>'.$row_bc['bc_numero'].'</b></td>
	<td height="'.$taille.'" width="150" style="text-align:center;"><b>'.$row_bc['bc_quantite'].'</b></td>
		<td style="text-align:center;" height="'.$taille.'" width="150"><b>'.$row_bc['bc_date'].' </b></td>
	<td style="text-align:center;" height="'.$taille.'" width="150"><b>'.$row_bc['v_registration_no'].'</b></td>
...
<tr style="text-align:left;">
	<td height="'.$taille.'" width="201"><b> </b>
	</td>
