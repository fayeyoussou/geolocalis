        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url(); ?>/dashboard">Tableau de bord</a>| <a href="<?= base_url(); ?>incomeexpense">Rapport</a></li>
...
-->
				<td> <?php if($incomexpenses['ie_bordereau_versement']==""){ ?><a href="<?php echo base_url(); ?>incomexpense/editincomexpense/<?php echo output($incomexpenses['ie_id']); ?>" class="btn btn-sm btn-success" data-toggle="modal" data-target="#modal-AddPayment">Banque Banque </a><?php }else{?><?php echo output($incomexpenses['ie_bordereau_versement']); ?> du <?php echo output($incomexpenses['ie_date_versement']); ?><?php }?> </td>
                          <?php if(userpermission('lr_ie_edit')) { ?>
                              <td>
