...
<?php }?>              
            <tr><? $montantTTC=0 ?>
              ...
              <td><b><? $montantTTC=$montantTVA+$montantHT;        $montantTTClettre=0;$montantTTC=12345600; 
                  //$montantTTClettre=$this->NumberToLetter( $montantTTC, '', '');
$montantTTClettre=NumberToLetter($montantTTC, '', ''); ?><? echo "bonjour".$montantTTClettre;?> <h3><?= $montantTTCAfficher = number_format($montantTTClettre, 0, ',', ' '); ?></h3></b></td>
            </tr>
<?php
/*
$val = $this->load->libraries('convertNumbersIntoWords');
$figure = 1234567890;
echo $this->convertNumbersIntoWords->convert_number($figure);
       $montantTTC=12345600;       
echo $montantTTClettre=$this->NumberToLetter( $montantTTC, '', '');*/
              ?>
