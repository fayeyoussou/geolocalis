...
<div class="col-sm-6 col-md-4">
	...
	<?php if((isset($incomexpensedetails)) && $incomexpensedetails[0]['ie_recu_bordereau_versement'] != '') {?>
                 ...
                 <input type="hidden" id="ie_created_date" name="ie_created_date" value="<?php echo date('Y-m-d h:i:s'); ?>">
                  ...
                  <input type="hidden" id="ie_espece_cheque" name="ie_espece_cheque" value="<?php echo "ESPECE"; ?>"><!--ENTREE-->
...
<div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <select id="ie_trip_id" name="ie_trip_id" class="form-control input-lg">
...
<div class="col-sm-6 col-md-4">
				...
				<div class="col-sm-6 col-md-4">
                 ...
                 <input type="hidden" id="ie_created_date" name="ie_created_date" value="<?php echo date('Y-m-d h:i:s'); ?>">
                  <input type="text" id="ie_compte_id" name="ie_compte_id" value="<?php echo "BANQUE"; ?>">
...
$(document).ready(function(){
 $('#ie_transitaire_id').change(function(){
  var ie_transitaire_id = $('#ie_transitaire_id').val();
...
//   url:"<?php //echo base_url(); ?>mission/fetch_state",
    method:"POST",
    data:{ie_transitaire_id:ie_transitaire_id},
    success:function(data)
    {
     $('#ie_trip_id').html(data);
...
/*$('#ie_transitaire_id').change(function(){
  ...
  {
   $.ajax({
     url:"<?php //echo base_url(); ?>incomexpense/fetch_ristourne",
