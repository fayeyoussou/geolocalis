        ...
        <div class="card card-primary card-tabs">
          <div class="card-header p-0 pt-1">
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="custom-tabs-one-non_validee-tab" data-toggle="pill" href="#custom-tabs-one-non_validee" role="tab" aria-controls="custom-tabs-one-non_validee" aria-selected="true">TOUTES LES MISSIONS</a>
              </li>
				
<li class="nav-item">
                <a class="nav-link" id="custom-tabs-one-livraison-tab" data-toggle="pill" href="#custom-tabs-one-livraison" role="tab" aria-controls="custom-tabs-one-livraison" aria-selected="true">LIVRAISON</a>
              </li>				
              ...
              <!--<li class="nav-item">
                <a class="nav-link" id="custom-tabs-one-validee-tab" data-toggle="pill" href="#custom-tabs-one-validee" role="tab" aria-controls="custom-tabs-one-validee" aria-selected="false">MISSIONS VALIDEES</a>
              </li>		-->	
 ...
 <?php //if((isset($missiondetails)) && $missiondetails[0]['mi_type_mission'] == "LIVRAISON"){  ?>
				...
				<div class="tab-pane fade show active" id="custom-tabs-one-non_validee" role="tabpanel" aria-labelledby="custom-tabs-one-non_validee-tab">
	<?php /*?><?php */?>			  
...
-->                          <th>Date mission</th>
                      ...
                      <?php $count=1;
                        ...
                        <td><span class="badge <?php echo ($missions['mi_validation']=='1') ? 'badge-success' : 'badge-danger'; ?> "><?php echo ($missions['mi_validation']=='1') ? 'Validé' : 'Non validé'; ?></span> 							
                          ...
                          <td> <?php echo output($missions['mi_validation_date']); ?>
...
<!-- debut taxe-->
                ...
                <div class="col-sm-6 col-md-3">
                 <div class="form-group">
                     ...
                     <select name="mi_prime" id="mi_prime" required="true" class="form-control selectized">
                      <option value="">Sélectionner Prime</option>
                      <option <?php if((isset($facturedetails)) && $facturedetails[0]['mi_prime'] ==1){ echo 'selected';} ?> value="1">Oui</option>

                      <option <?php if((isset($facturedetails)) && $facturedetails[0]['mi_prime'] ==0){ echo 'selected';} ?> value="0">Non</option>						 
                    </select>
                  </div>
                </div>                
...
-->                          <th>Date mission</th>
                      ...
                      <?php $count=1;
						...
						$mi_validation =  $missions['mi_validation'];	   
                      ...
                      <?php $count=1;
                        ...
                        <tr>
                         ...
                         <td><?= (isset($missions['conducteur']->d_name))?$missions['conducteur']->d_name:'<span class="badge badge-danger">Non renseigné</span>'; ?></td>
                           ...
                           <td> <?= (isset($missions['vehicule']->v_registration_no))?$missions['vehicule']->v_registration_no:'<span class="badge badge-danger">Non renseigné</span>'; ?></td>							
							
                            <!--<td> <?//= (isset($missions['facture']->t_num_facture))?$missions['facture']->t_num_facture:'<span class="badge badge-danger">Non renseigné</span>'; ?></td>-->
							
                            <td> <?= (isset($missions['conteneur']->co_type_conteneur))?$missions['conteneur']->co_type_conteneur:'<span class="badge badge-danger">Non renseigné</span>'; ?></td>
                           ...
                           <!--<td><?php //echo output($missions['pr_numero']); ?><?php //echo ucfirst($missions['pregate']->pr_numero); ?><?//= (isset($missions['transitaire']->tra_name))?$missions['transitaire']->tra_name:'<span class="badge badge-danger">Non renseigné</span>'; ?></td>-->
                        <!-- <td>
							<?//= join_multi_select($missions['mi_conteneur_id'], 'trip_conteneur', 'co_id', 'co_numero_conteneur'); ?></td>-->
<td> 
<?= (isset($missions['facture']->t_transitaire))?join_multi_select($missions['facture']->t_transitaire, 'transitaire', 'tra_id', 'tra_name'):'<span class="badge badge-danger">Non renseigné</span>'; ?>							
							</td>
<td> 
<?= (isset($missions['conteneur']->co_zone))?join_multi_select($missions['conteneur']->co_zone, 'zone', 'z_id', 'z_destination'):'<span class="badge badge-danger">Non renseigné</span>'; ?>							
							</td>							
						...
						<td>	 
					   <span class="badge <?php echo ($missions['mi_validation']=='1') ? 'badge-success' : 'badge-danger'; ?> "><?php echo ($missions['mi_validation']=='1') ? 'Validé' : 'Non validé'; ?></td>
