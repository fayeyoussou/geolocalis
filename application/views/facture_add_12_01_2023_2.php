              ...
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                   <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Transport") && ($url == "editfacture")){	?> 
					...
					<li class="nav-item"><a class="nav-link" href="#exportation" data-toggle="tab">Exportation</a></li> <?php }?> 
                     <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Transfert") && ($url == "editfacture")){	?>
					<li class="nav-item"><a class="nav-link" href="#transfert" data-toggle="tab">Transfert</a></li> <?php }?> 
                 <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Immobilisation") && ($url == "editfacture")){	?>
					<li class="nav-item"><a class="nav-link" href="#immobilisation" data-toggle="tab">Immobilisation</a></li> <?php }?> 
                     <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Manutentation") && ($url == "editfacture")){	?> <li class="nav-item"><a class="nav-link" href="#manutentation" data-toggle="tab">Manutentation</a></li> <?php }?> 
					
    <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Detention") && ($url == "editfacture")){	?>
<li class="nav-item"><a class="nav-link" href="#detention" data-toggle="tab">Détention</a></li>  <?php }?>  
    <?php if(((isset($facturedetails)) && $facturedetails[0]['t_type_facturation'] =="Forfait") && ($url == "editfacture")){	?>					
                  <li class="nav-item"><a class="nav-link" href="#forfait" data-toggle="tab">Forfait</a></li> <?php }?>
				</ul>
              </div><!-- /.card-header -->
              <div class="card-body">
