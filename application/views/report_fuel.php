<div class="content-header">
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6">
            <h1 class="m-0 text-dark">Rapport carburant
            </h1>
         </div>
         <!-- /.col -->
         <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               ...
               <li class="breadcrumb-item active">Rapport carburant</li>
            </ol>
         </div>
         <!-- /.col -->
      </div>
             ...
             ?>
                   <table class="datatableexport table card-table">
                      <thead>
                        <tr>
                          <th class="w-1">N°</th>
                           <th>Date de remplissage de carburant</th>
                          <th>Véhicule</th>
                          <th>Quantité</th>
                          <th>Prix total du carburant</th>
                          <th>Carburant rempli par</th>
