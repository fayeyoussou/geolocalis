        ...
        <div class="card card-primary card-tabs">
          <div class="card-header p-0 pt-1">
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link" id="custom-tabs-one-suite-tab" data-toggle="pill" href="#custom-tabs-one-suite" role="tab" aria-controls="custom-tabs-one-suite" aria-selected="true">5.	SUITES</a>
              </li>	
...
<!-- BEGIN SELECT-->
   ...
   <select name="mi_trip_id_livraison" id="mi_trip_id_livraison" class="form-control selectized">
...
<div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <select id="mi_conteneur_id_livraison" name="mi_conteneur_id_livraison[]" multiple class="select2"  >
...
<div class="col-sm-6 col-md-3">
		...
		<div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <select required id="mi_vehicle_id_livraison" class="form-control selectized" name="mi_vehicle_id_livraison" >
...
<!-- BEGIN SELECT-->
   ...
   <select name="mi_trip_id_mise_terre" id="mi_trip_id_mise_terre" class="form-control selectized">
    <option value="">Selectionner Pregate</option>
    <?php
/*    foreach($pregate as $row)
    {
...
<div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label"> Conteneur<span class="form-required">*</span></label>
                     <select id="mi_conteneur_id_mise_terre" name="mi_conteneur_id_mise_terre[]" multiple class="select2"  >
						  <!--<select id="mi_conteneur_id" class="form-control selectized" name="mi_conteneur_id[]" multiple   >input-lg-->
                        <option value="">Sélectionner le Conteneur</option>
                        <?php if(isset($missiondetails)) { foreach ($conteneurlist as $key => $conteneurlists) { ?>
                        <option <?php //if((isset($missiondetails)) && $missiondetails[0]['mi_conteneur_id'] == $conteneurlists['co_id']){ echo 'selected';} ?> 
...
<div class="col-sm-6 col-md-3">
	 ...
	 foreach($lieu_livraisonlist as $row) { ?>
		...
		<div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label">Véhicule<span class="form-required">*</span></label>
                     <select required id="mi_vehicle_id_mise_terre" class="form-control selectized" name="mi_vehicle_id_mise_terre" >
                        <option value="">Sélectionner Véhicule</option>
                        <?php  foreach ($vechiclelist as $key => $vechiclelists) { ?>
                        <option <?php if((isset($missiondetails)) && $missiondetails[0]['mi_vehicle_id'] == $vechiclelists['v_id']){ echo 'selected';} ?> value="<?php echo output($vechiclelists['v_id']) ?>"><?php echo output($vechiclelists['v_name']).' - '. output($vechiclelists['v_registration_no']); ?></option>
                        <?php  } ?>
...
<div class="col-sm-6 col-md-3">
	 ...
	 foreach($lieu_livraisonlist as $row) { ?>
		...
		<div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label">Véhicule<span class="form-required">*</span></label>
                     <select required id="mi_vehicle_id" class="form-control selectized" name="mi_vehicle_id" >
                        <option value="">Sélectionner Véhicule</option>
                        <?php  foreach ($vechiclelist as $key => $vechiclelists) { ?>
                        <option <?php if((isset($missiondetails)) && $missiondetails[0]['mi_vehicle_id'] == $vechiclelists['v_id']){ echo 'selected';} ?> value="<?php echo output($vechiclelists['v_id']) ?>"><?php echo output($vechiclelists['v_name']).' - '. output($vechiclelists['v_registration_no']); ?></option>
                        <?php  } ?>
...
<div class="col-sm-6 col-md-3">
		...
		<div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label">Véhicule<span class="form-required">*</span></label>
                     <select required id="mi_vehicle_id_garage" class="form-control selectized" name="mi_vehicle_id_garage" >
                        <option value="">Sélectionner Véhicule</option>
                        <?php  foreach ($vechiclelist as $key => $vechiclelists) { ?>
                        <option <?php if((isset($missiondetails)) && $missiondetails[0]['mi_vehicle_id'] == $vechiclelists['v_id']){ echo 'selected';} ?> value="<?php echo output($vechiclelists['v_id']) ?>"><?php echo output($vechiclelists['v_name']).' - '. output($vechiclelists['v_registration_no']); ?></option>
                        <?php  } ?>
...
<!--DEBUT SUITE-->
<div class="tab-pane fade show" id="custom-tabs-one-suite" role="tabpanel" aria-labelledby="custom-tabs-one-suite-tab">
...
<div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <select name="mi_lieu_livraison"  class="form-control input-lg" required>						 
                        <option value="">Sélectionner le lieu livraison</option>
	 ...
	 foreach($lieu_livraisonlist as $row) { ?>
		...
		<div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label">Chauffeur<span class="form-required">*</span></label>
                     <select id="mi_driver_id_suite" class="form-control selectized" name="mi_driver_id" required>
                       <option value="">Selectionner chauffeur</option>
                        <?php  foreach ($driverlist as $key => $driverlists) { ?>
                        <option <?php if((isset($missiondetails)) && $missiondetails[0]['mi_driver_id'] == $driverlists['d_id']){ echo 'selected';} ?> value="<?php echo output($driverlists['d_id']) ?>"><?php echo output($driverlists['d_name']); ?></option>
                        <?php  } ?>
		...
		<div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label">Véhicule<span class="form-required">*</span></label>
                     <select required id="mi_vehicle_id_suite" class="form-control selectized" name="mi_vehicle_id" >
                        <option value="">Sélectionner Véhicule</option>
                        <?php  foreach ($vechiclelist as $key => $vechiclelists) { ?>
                        <option <?php if((isset($missiondetails)) && $missiondetails[0]['mi_vehicle_id'] == $vechiclelists['v_id']){ echo 'selected';} ?> value="<?php echo output($vechiclelists['v_id']) ?>"><?php echo output($vechiclelists['v_name']).' - '. output($vechiclelists['v_registration_no']); ?></option>
                        <?php  } ?>
...
<!-- Fin Carte Carburant-->                    
   ...
   <!-- FIN MISSION-->
 	...
 	<div id="mi_bon_carburant_id_suite">
	</div>	     
                </div>
<?php if((isset($missiondetails))){}else{ ?>			  
                 <input type="hidden" id="mi_created_date" name="mi_created_date" value="<?php echo date('Y-m-d h:i:s'); ?>">
...
/* $('#mi_type_transport').change(function(){
  ...
  {
   $.ajax({
     url:"<?php //echo base_url(); ?>mission/fetch_lieu_livraison",
    method:"POST",
    data:{mi_type_transport:mi_type_transport},
    success:function(data)
    {
     $('#mi_lieu_livraison').html(data);
    }
   });
  }
  else
