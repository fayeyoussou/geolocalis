      ...
      <div class="col-12 table-responsive">
        <table class="table table-striped">
          ...
          <tr>
            ...
            <td><?= output($data['s_price_prefix']).$facturedetails['t_trip_amount'] ?></td>
          </tr>
          </tbody>
        </table>
      </div>
      ...
      <div class="col-4">
        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tr>
              <th><?= ($facturedetails['t_trip_amount'] > $totalpaidamt)?'Pending':'Excess' ?>:</th>
              <td><?= output($data['s_price_prefix']) .preg_replace('/[^\d\.]+/','',$facturedetails['t_trip_amount'] - $totalpaidamt)  ?></td>
            </tr>
          <?php } ?>
          </table>
        </div>
