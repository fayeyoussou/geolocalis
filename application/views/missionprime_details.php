            ...
            <div class="card card-primary card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-one-reglement-tab" data-toggle="pill" href="#custom-tabs-one-reglement" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="false">Reglement</a>
                  </li>
                 <li class="nav-item">
...
<?php }// FIN controle Exportation ou Transport?>       
 ...
 <!--BEGIN TRANSFERT-->
<?php // FIN controle Exportation ou Transport
if((($facturedetails['t_type_facturation'])=="Transfert")) 
{                
?>                
...
-->                
                ...
                <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal-pregate">Ajouter PREGATE</a>				  
...
<div class="modal fade show" id="modal-pregate" aria-modal="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Ajouter Pregate de la facture N° <?= $facturedetails['t_num_facture']; ?> </h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
      <div class="modal-body">
        <form class="form-horizontal" id="trippayments" action="<?= base_url() ?>facture/facturepregate" method="post">
                <div class="card-body">

                  <div class="form-group row">
                    <label for="paidamount" class="col-sm-4 col-form-label">Nombre de conteneurs</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="pr_nombre_conteneur" value="" id="pr_nombre_conteneur" placeholder="Nombre de conteneurs" >
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-group col-sm-8">
                       <input type="text" class="form-control" name="pr_numero" id="pr_numero" placeholder="Numéro">
                    </div>
                  </div>   
					...
					<div class="form-group row">
                    <label for="tp_amount" class="col-sm-4 col-form-label">Date line</label>
                    <div class="form-group col-sm-8">
                        <input type="text" class="form-control datepicker" id="pr_date_line" name="pr_date_line" value="" placeholder="Date line">
                    </div>
                  </div>						
                   ...
                   <div class="form-group row">
                    <label for="tp_notes" class="col-sm-4 col-form-label">Notes</label>
                    <div class="form-group col-sm-8">
                      <textarea class="form-control" id="pr_notes" name="pr_notes" rows="2" placeholder="Saisir Notes"></textarea>
                    </div>
                  </div>
                </div>
            

                 <input type="hidden" class="form-control" value="<?= $facturedetails['t_id']; ?>" name="pr_trip_id" id="pr_trip_id" >
...
<select id="co_zone"  class="form-control"  name="co_zone">
                       <option value="">Selectionner la zone</option>
                        <?php  foreach ($zoneselect as $key => $zonelists) { ?>
                        <option value="<?php echo output($zonelists['z_id']) ?>"><?php echo output($zonelists['z_destination']); ?></option>
                        <?php  } ?>
                     </select>
                    </div>
                  </div>  
...
<!-- debut Type de conteneur-->
 ...
 <!---->                                      
<div class="form-group row">
                    <label for="co_adresse_livraison" class="col-sm-4 col-form-label">Montant</label>
                    <div class="form-group col-sm-8">
                      <input type="text" class="form-control" name="co_montant" id="co_montant">
                    </div>
                  </div>					
...
<!--                 <input type="text" class="form-control" value="expense" name="ie_type" id="ie_type">-->
			 ...
			 <input type="hidden" class="form-control" value="transfert" name="t_type_facturation" id="t_type_facturation">
                 <input type="hidden" class="form-control" value="<?= $facturedetails['t_id']; ?>" name="co_trip_id" id="co_trip_id">
        <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-default" data-dismiss="modal">Fermer</button>
