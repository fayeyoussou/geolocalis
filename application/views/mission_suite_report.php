        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-3">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="<?= base_url(); ?>reports/mission">RETOUR</a></li>
            </ol>
         </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<?php $mi_validation=0; $mi_validation =  $missions['mi_validation']; //echo $t_annulation;
                        if($mi_validation==0) { ?> 							
	 <td><a data-toggle="tooltip" data-placement="top" title="Validation" class="icon" class="icon" href="<?php echo base_url(); ?>mission/mission_validation_suite/<?php echo output($missions['mi_id']); ?>/<?= $this->uri->segment(3)?>">
