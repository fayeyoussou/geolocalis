                    ...
                    <table id="pregatetbl" class="datatableexport table card-table table-vcenter">
                      ...
                      <?php $count=1;
                        ...
                        <tr>
                           ...
                           <td> <?php echo output($pregates['pr_trip_id']); ?><?php echo output($pregates['t_num_facture']); ?> <?php //echo output($pregates['vech_name']->v_name).'_'.output($pregates['vech_name']->v_registration_no); ?></td>
                        ...
                        <td><?php echo output($pregates['cc_name']); ?></td>
                          <td><?php 
							   ...
							   if(isset($pregates['co_type_conteneur'])){$type=$pregates['co_type_conteneur']; ?><?php if($type=='20_pieds'){ echo "20 pieds";} else {echo "40 pieds";} ?><?php } ?>  </td>							
                          <td>  <span class="badge <?php echo ($pregates['pr_statut']=='1') ? 'badge-success' : 'badge-danger'; ?> "><?php echo ($pregates['pr_statut']=='1') ? 'Effectué' : 'Instance'; ?></span>  </td>
                          <?php if(userpermission('lr_pr_edit')) { ?>
                              <td>
							...
							<?php  if(userpermission('lr_mi_add')) { ?>	  
								<a class="icon" href="<?php echo base_url(); ?>pregate/pregatedetails/<?php echo output($pregates['pr_trip_id']); ?>">
								  <i class="fa fa-eye"></i>
								</a>
							<?php } ?>
                          </td>
