...
} // FIN controle Importation et Exportation
...
$html = '<table border="0" cellspacing="0" align="center" width="100%" > 
        <tr height="20" style="color:#000;border:1px solid #000;">
            ...
            <th width="20%"><h5>DATE DEBUT</h5></th>
            <th width="20%"><h5>DATE FIN</h5></th>
            <th width="15%"><h5>TYPE</h5></th>
           <th width="15%"><h5>TAUX</h5></th>
            <th width="30%"><h5>DETENTION</h5></th>
            <th width="12%"><h5>MONTANT</h5></th>
      </tr>         
         <tbody>';
