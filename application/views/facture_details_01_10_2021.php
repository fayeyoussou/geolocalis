...
<?php if(isset($conteneurdetails['co_type_conteneur'])){$type=$conteneurdetails['co_type_conteneur']; ?><?php if($type=='20_pieds'){ $montant=15000;} else {$montant=25000;} ?><?php } ?>                          
                          <td>
                          </td>
<!--                      <td><?php //if(isset($conteneurdetails['zone_name']->z_destination)){echo output($conteneurdetails['zone_name']->z_destination) ;} ?> <?php //if(isset($conteneurdetails['co_adresse_livraison'])){?> - <?php //echo output($conteneurdetails['co_adresse_livraison']) ;} ?></td>
                      <td><?php echo output($montant); ?></td>-->
                      <td><?php echo output($conteneurdetails['co_nombre_jour']); ?></td>
                      <td><?php echo output($conteneurdetails['co_montant']); ?></td>
...
<div class="modal fade show" id="modal-import" aria-modal="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="addfactureconteneur" action="<?= base_url() ?>facture/<?php echo (isset($conteneuredit))?'updatefactureconteneur':'addfactureconteneur'; ?>" method="post">
                <div class="card-body">
                  <div class="form-group row">
...
<!-- -->                  <div class="form-group row">
                    <label for="co_montant" class="col-sm-4 col-form-label">Nombre de jours</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" required="true" name="co_nombre_jour" id="co_nombre_jour" placeholder="Nombre de jours">
