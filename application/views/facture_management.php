...
<!--                      <th>Statut facture</th>-->
                      ...
                      <?php if(!empty($journal_facture)){ 
                           $count=1;
							$montant_total_tva =0;
							$montant_total_facture = 0;
                           foreach($journal_facture as $facturelists){
                           ?>
                        <tr>
                            <td> <?php echo output($count); $count++; ?></td>
                          <td> <?php echo ucfirst($facturelists['t_type_facturation']); ?></td>
                          <td> <?php echo output($facturelists['t_reference']); ?></td>
...
<thead>
                        <tr>
						  ...
						  <th></th>
                          <th></th>
						  <th><?php  if(!empty($journal_facture)){ if($montant_total_tva){$montant_total_tva = number_format($montant_total_tva, 0, ',', ' ');echo output($montant_total_tva);} } ?><?//= $montant_total_tva; ?></th>
                          <th><?//= $montant_total_facture; ?><?php  if(!empty($journal_facture)){if($montant_total_facture){$montant_total_facture = number_format($montant_total_facture, 0, ',', ' ');echo output($montant_total_facture);} }?></th>
                          <th></th>
						  <th></th>
						  <th></th>
                        </tr>
