...
<div class="wrapper">
  ...
  <section class="col-12" class="invoice">
    ...
    <div class="row invoice-info">
      ...
      <!-- /.col -->
      <div class="col-sm-4 invoice-col">
        <b>Facture #<?= output($data['s_inovice_prefix']).date('Ym').$facturedetails['t_id']; ?></b><br>
        <br>
...
<!--          <tr>
            ...
            <td>De  <br> <?//= $facturedetails['t_trip_fromlocation']; ?> <br> à <br><?//= $facturedetails['t_trip_tolocation']; ?> </td>
            <td><?//= output($facturedetails['t_trip_amount']); ?> <?//= $data['s_price_prefix']; ?><?//= output($data['s_price_prefix']).$facturedetails['t_trip_amount'] ?></td>
          </tr>-->
...
<!--                      <td><?php// echo output($conteneurdetails['co_description']); ?></td>
        ...
        <div class="table-responsive">
          <table class="table">
            <tr>
              ...
              <td><?= $facturedetails['t_trip_amount'] ?>  <?= $data['s_price_prefix']; ?> <?//= output($data['s_price_prefix']).$facturedetails['t_trip_amount'] ?></td>
            </tr>
            <tr>
              <th>Payé:</th>
