...
<!-- BEGIN SELECT-->
   ...
   <select name="ei_pregate_id" id="mi_trip_id" class="form-control selectized">
    ...
    {
     echo '<option value="'.$row->pr_id.'">'.$row->pr_numero.'</option>';
    }
    ?>
   </select>				  
<!-- END SELECT-->					  
                    ...
                    <table id="eir_videtbl" class="table card-table">
                      ...
                      <?php $count=1;
                        ...
                        <tr>
                           ...
                           <td> <?php echo output($eir_vides['ei_mission_id']); //ei_driver_id?><?php //echo ucfirst($this->drivers_model->getById($eir_vides->ei_driver_id)->d_name); ?></td>
...
$(document).ready(function(){
 $('#ei_mission_id').change(function(){
  ...
  {
   $.ajax({
     url:"<?php echo base_url(); ?>eir_vide/fetch_information_mission",
//   url:"<?php //echo base_url(); ?>mission/fetch_state",
    method:"POST",
...
/* BEGIN LIEU RESTITUTION*/	
 $('#mi_trip_id').change(function(){
  ...
  {
   $.ajax({
     url:"<?php echo base_url(); ?>eir_plein/fetch_lieu_restitution",
//   url:"<?php //echo base_url(); ?>mission/fetch_state",
    method:"POST",
    data:{mi_trip_id:mi_trip_id},
    success:function(data)
