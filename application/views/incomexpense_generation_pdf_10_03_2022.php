...
<table align="center" cellspacing="0" cellpadding="0" border="0">
    <tr>
        <td rowspan="3"><h2>Détails du reglement N°: '.$incomexpense_generation['ie_numero_enregistrement'].'</h2></td>
    </tr>
</table>';
...
$tbl = '<table width="350"  >
    <tr>
        ...
        <td width="10">:</td>
        <td width="250">'.$incomexpense_generation['ie_numero_enregistrement'].'</td>
        <td width="130"><b>REFERENCE BL</b></td>
        <td width="10">:</td>
        <td width="150">'.$incomexpense_generation['ie_numero_enregistrement'].'</td>
    </tr>
    ...
    <tr>
        ...
        <td width="10">:</td>
        <td width="150">'.$incomexpense_generation['t_date_facture'].'</td>
...
$html = '<table border="0" cellspacing="0" align="center" width="100%" > 
    ...
    if(($incomexpense_generation['t_type_facturation'])=="Exportation")// Debut du controle if
    {
     $ags=1500;   
    }
    else
...
{ $type='';
 ...
 else
 {
      ...
      $html .=  '<td width="10%">'.$count.'</td>
            <td width="15%">'.$incomexpense_generation['t_type_facturation'].'</td>
...
// $nombreags += $incomexpense_generation['t_nombre_ags'];
// $nombreags += $incomexpense_generation['t_nombre_ags'];
}
...
//$montantags=$incomexpense_generation['t_frais_ags'];
//$nombreags= 0;
//$nombreags= $incomexpense_generation['t_nombre_conteneur'] * $incomexpense_generation['t_nombre_ags'];
...
// deduction du rabais
/*$rabais = 0;    
$rabais = $incomexpense_generation['t_rabais'];   
...
$t_frais_divers = 0;    
$t_frais_divers = $incomexpense_generation['t_frais_divers'];   
...
/*$montantTVA=0;
$montant_total=""; */ 
if($incomexpense_generation['t_taxe']=='avec_tva')
{
    //ceil(1.1)
...
/*$tva=0;
$tva=$incomexpense_generation['t_taxe'];*/
...
$html .= '<h5><tr style="background-color:#F2F2F2;color:#000000;">
    ...
    if($incomexpense_generation['t_modele_facture']=="FACTURE"){ //controle du modéle de facture
  $html .= '<h5><tr style="background-color:#F2F2F2;color:#000000;">
            <td></td>
            <td></td>
            <td></td>
...
$pdf->writeHTML($html, false, false, true, false, '');
    ...
    /* DEBUT DETENTION*/
 if(($incomexpense_generation['t_type_facturation'])=="Detention") 
{// Debut du controle if
