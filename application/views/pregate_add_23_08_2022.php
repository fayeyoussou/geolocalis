               ...
               <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <select id="pr_trip_id"  class="form-control selectized"  name="pr_trip_id" >
                        <option value="">Sélectionner le BL</option>
                        <?php $count=1;  foreach ($facturelist as $key => $facturelists) { ?>
                        <option  value="<?php echo output($facturelists['t_id']) ?>"><?php //echo $count; ?>  <?php //echo output($facturelists['t_id']); ?> <?php echo output($facturelists['t_reference']); ?></option>
                        <?php  $count++;} ?>
                     </select>
                  </div>
               </div>                      
				...
				<div class="col-sm-6 col-md-4">
                      <div class="form-group">
                         ...
                         <input type="text" class="form-control datepicker" id="from" name="from" value="" placeholder="Date début">
				...
				<div class="col-sm-6 col-md-4">
                      <div class="form-group">
                         ...
                         <input type="text" class="form-control datepicker" id="to" name="to" value="" placeholder="Date fin">
