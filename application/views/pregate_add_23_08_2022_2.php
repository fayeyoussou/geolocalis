         ...
         <div class="card-body">
            <div class="row">
				...
				<div class="col-sm-6 col-md-4">
                      <div class="form-group">
                          <label class="form-label">Date début reception<span class="form-required"></span></label>
                         <input type="text" class="form-control datepicker" id="from" name="from_reception" value="" placeholder="Date début reception">
				...
				<div class="col-sm-6 col-md-4">
                      <div class="form-group">
                          <label class="form-label">Date fin reception<span class="form-required"></span></label>
                         <input type="text" class="form-control datepicker" id="to" name="to_reception" value="" placeholder="Date fin reception">
				...
				<div class="col-sm-6 col-md-4">
                      <div class="form-group">
                          <label class="form-label">Date début line<span class="form-required"></span></label>
                         <input type="text" class="form-control datepicker" id="from" name="from_line" value="" placeholder="Date début line">
				...
				<div class="col-sm-6 col-md-4">
                      <div class="form-group">
                          <label class="form-label">Date fin line<span class="form-required"></span></label>
                         <input type="text" class="form-control datepicker" id="to" name="to_line" value="" placeholder="Date fin line">
                    ...
                    <div class="col-sm-4 col-md-3">
                      <div class="form-group">
                          <label for="pr_statut" class="form-label">Recherche</label>
                        <select id="pr_statut" name="pr_statut" class="form-control selectized">
                          <option value="">Selectionner statut</option> 
                          <option value="1">Plein</option> 
                          <option value="0">Vide</option> 
