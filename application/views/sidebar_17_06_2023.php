...
<!-- DEBUT VALIDATION-->			 
   <?php   if(userpermission('lr_reports')) { ?>
            <li class="nav-item has-treeview <?php echo ((activate_menu('incomeexpense'))=='active') ? 'menu-open':'' ?> <?php echo ((activate_menu('booking'))=='active') ? 'menu-open':'' ?><?php echo ((activate_menu('fuels'))=='active') ? 'menu-open':'' ?><?php echo ((activate_menu('fuel_peage'))=='active') ? 'menu-open':'' ?>">
...
<!--Fin comptabilité-->		
            ...
            <li class="nav-item has-treeview <?php echo ((activate_menu('addmission'))=='active') ? 'menu-open':'' ?>
               <?php echo ((activate_menu('addmission'))=='active') ? 'menu-open':'' ?> <?php echo ((activate_menu('addeir_plein_vide'))=='active') ? 'menu-open':'' ?><?php echo ((activate_menu('editmission'))=='active') ? 'menu-open':'' ?> <?php echo ((activate_menu('pregate'))=='active') ? 'menu-open':'' ?>
               <?php echo ((activate_menu('addpregate'))=='active') ? 'menu-open':'' ?><?php echo ((activate_menu('editpregate'))=='active') ? 'menu-open':'' ?>">
               <a href="#" class="nav-link <?php echo activate_menu('mission');?> <?php echo activate_menu('addmission');?><?php echo activate_menu('editmission');?><?php echo activate_menu('addeir_plein_vide');?>">
                  <i class="nav-icon fas fa-road"></i>
                  <p>
                     2 - Gestion Transport
                     <i class="right fas fa-angle-left"></i>
...
<!---->                  <li class="nav-item">
                     <a href="<?= base_url(); ?>eir/addeir_plein_vide" class="nav-link <?php echo activate_menu('eir_plein');?>">
                        <i class="nav-icon fas faa-plus"></i>
                        <p>Gestion des EIR PLEINS & VIDES</p>
                     </a>
                  </li>
                  <?php //} ?>
...
<!--BEGIN MAINTENANCE-->
            ...
            <li class="nav-item has-treeview <?php echo ((activate_menu('compte'))=='active') ? 'menu-open':'' ?>
               ...
               <ul class="nav nav-treeview">
                  ...
                  <?php  if(userpermission('lr_comp_add')) { ?>
                  <li class="nav-item">
                     <a href="<?= base_url(); ?>incomexpense/addincomexpense_piece_rechange" class="nav-link <?php echo activate_menu('addincomexpense_piece_rechange');?>">
                        <i class="nav-icon fas faa-plus"></i>
                        <p>Ajouter </p>
                     </a>
                  </li>
...
<!-- DEBUT CARBURANT-->
            ...
            <li class="nav-item has-treeview <?php echo ((activate_menu('fuel'))=='active') ? 'menu-open':'' ?>
               <?php echo ((activate_menu('addfuel'))=='active') ? 'menu-open':'' ?> <?php echo ((activate_menu('editfuel'))=='active') ? 'menu-open':'' ?><?php echo ((activate_menu('addfuel_compagnie'))=='active') ? 'menu-open':'' ?>">
