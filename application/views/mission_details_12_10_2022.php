              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <tbody>
                    <tr>
                      <td>Numéro </td>
                      <td><?= output($missiondetails['pr_numero']) ?></td>
                    </tr>
                    <tr>
                      <td>Statut</td>
                  ...
                  <tbody>
                    <tr>
                      <td>Numéro transaction 1</td>
                      <td><?= output($eir_plein['ei_numero_transaction']) ?></td>
                    </tr>
                    <tr>
                      <td>Statut</td>
                      <td><?//= output($missiondetails['mi_isactive']) ?><span class="badge <?php echo ($eir_plein['e_isactive']=='1') ? 'badge-success' : 'badge-danger'; ?> "><?php echo ($eir_plein['ei_isactive']=='1') ? 'Plein' : 'Vide'; ?></span> </td>
                    </tr>
                    <tr>
                      <td>Validation</td>
                      <td><?//= output($missiondetails['mi_validation']) ?><span class="badge <?php echo ($eir_plein['ei_validation']=='1') ? 'badge-success' : 'badge-danger'; ?> "><?php echo ($eir_plein['ei_validation']=='1') ? 'Validé' : 'Non validé'; ?></span></td>
                    </tr>
                      <tr>
                      <td>Véhicule</td>
                      <td><?= output($eir_plein['ei_date']) ?></td>
                    </tr>
                    <tr>
                      <td>Conducteur</td>
                      <td><?= output($eir_plein['ei_heure']) ?></td>
                    </tr>
...
<table class="table table-sm table-bordered">
                  <tbody>
                    <tr>
                      ...
                      <td><?= output($eir_vide['ei_numero_transaction']) ?></td>
                    </tr>
                    <tr>
                      <td>Statut</td>
                      <td><?//= output($missiondetails['mi_isactive']) ?><span class="badge <?php echo ($eir_vide['ei_isactive']=='1') ? 'badge-success' : 'badge-danger'; ?> "><?php echo ($eir_vide['ei_isactive']=='1') ? 'Plein' : 'Vide'; ?></span> </td>
                    </tr>
                    <tr>
                      <td>Validation</td>
                      <td><?//= output($missiondetails['mi_validation']) ?><span class="badge <?php echo ($eir_vide['ei_validation']=='1') ? 'badge-success' : 'badge-danger'; ?> "><?php echo ($eir_vide['ei_validation']=='1') ? 'Validé' : 'Non validé'; ?></span></td>
                    </tr>
                      <tr>
                      <td>Date</td>
                      <td><?= output($eir_vide['ei_date']) ?></td>
                    </tr>

                     <tr>
                      <td>Heure</td>
                      <td><?= output($eir_vide['ei_heure']) ?></td>
                    </tr>
...
<!-- END TAB EIR-->					
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <tr>
                      <td>Véhicule</td>
                      <td><?= output($missiondetails['mi_vehicle_id']) ?></td>
                    </tr>
                    <tr>
                      <td>Conducteur</td>
                      <td><?= output($missiondetails['mi_driver_id']) ?></td>
                    </tr>
<!-- -->            <tr>
                      <td>Montant</td>
                     ...
                     <tr>
                      ...
                      <td><?= output($missiondetails['mi_lieu_restitution_id']) ?></td>
                    </tr>
                     <tr>
                      <td>Frais AGS</td>
                     ...
                     <tr>
					  ...
					  <tr>
                      <td>Remorque</td>
                      <td><?= output($missiondetails['mi_vehicle_remorque_id']) ?></td>
                    </tr>
                     <tr>
                      <td>Date de la mission</td>
                      <td><?= output($missiondetails['mi_date_mission']) ?></td>
