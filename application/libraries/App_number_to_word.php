...
//        $this->load->library('App_number_to_word', $language);
          $this->load->library('App_french_num_words_lang');
//          $this->library->load('App_french_num_words_lang.php');
//        $this->ci->lang->load($language . '_num_words_lang', $language);

        if (file_exists(APPPATH . 'App_french_num_words_lang.php')) {
//        if (file_exists(APPPATH . 'language/' . $language . '/custom_lang.php')) {

            // Unset the previous custom_lang in case is already loaded before num_words_lang
            if (isset($this->ci->lang->is_loaded['App_french_num_words_lang.php'])) {
                unset($this->ci->lang->is_loaded['App_french_num_words_lang.php']);
            }
