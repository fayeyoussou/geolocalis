...
if (!defined('PDF_FOOTER_LOGO')) {
	$tcpdf_footer_logo = '';
	if (@file_exists(K_PATH_IMAGES.'tcpdf_footer.jpg')) {
		$tcpdf_footer_logo = 'tcpdf_footer.jpg';
	}
	define ('PDF_FOOTER_LOGO', $tcpdf_footer_logo);
}

if (!defined('PDF_FOOTER_LOGO_WIDTH')) {
	if (!empty($tcpdf_footer_logo)) {
		define ('PDF_FOOTER_LOGO_WIDTH', -15);
	} else {
		define ('PDF_FOOTDER_LOGO_WIDTH',262);
	}
}
//  Fin footer
