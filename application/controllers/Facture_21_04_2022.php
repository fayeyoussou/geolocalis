...
/* INSERT CONTROL BL */
			$exist = $this->db->select('*')->from('trips')->where('t_reference',$this->input->post('t_reference'))->get()->result_array();//modifier
			if(count($exist)==0) {			
/* INSERT CONTROL BL*/			
		   //echo "dddd";exit;
...
/* INSERT CONTROL BL*/				
				...
				$this->session->set_flashdata('warningmessage', 'Un BL du même nom existe déjà.');
			}				
/* INSERT CONTROL BL*/				
