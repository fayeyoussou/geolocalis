...
//		$data['vehiclelist'] = $this->vehicle_model->getall_vehicle();
 ...
 //       $ie_beneficiaire = 0;
		...
		if($ie_type=="expense"){
			$addincomexpense = array('ie_date'=>$ie_date,'ie_type_mouvement'=>$ie_type_mouvement,'ie_amount'=>$ie_amount,'ie_description'=>$ie_description,'ie_type'=>$ie_type,'ie_numero'=>$ie_numero,'ie_numero_enregistrement'=>$ie_numero_enregistrement,'ie_beneficiaire'=>$ie_beneficiaire,'ie_objet'=>$ie_objet,'ie_compte_id'=>$ie_compte_id,'ie_created_date'=>$ie_created_date);		
		}else{
		$addincomexpense = array('ie_date'=>$ie_date,'ie_type_mouvement'=>$ie_type_mouvement,'ie_amount'=>$ie_amount,'ie_description'=>$ie_description,'ie_type'=>$ie_type,'ie_numero'=>$ie_numero,'ie_numero_enregistrement'=>$ie_numero_enregistrement,'ie_created_date'=>$ie_created_date);			
		}			
//	}
...
if(($ie_type=="expense") && ($ie_compte_id==180)){
			$fjc_type='';
			$fjc_type='CAISSE';
	$add_fuel_journal_carburant = '';
		$add_fuel_journal_carburant = array('fjc_ie_id'=>$last_incomexpense_id,'fjc_ie_numero'=>$ie_numero_enregistrement,'fjc_date'=>$ie_date,'fjc_quantite'=>$ie_amount,'fjc_description'=>$ie_description,'fjc_created_date'=> $ie_created_date,'fjc_type'=>$fjc_type);		
