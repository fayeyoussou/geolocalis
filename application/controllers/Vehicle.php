...
class Vehicle extends CI_Controller {
	...
	{
		$data['vehiclelist'] = $this->vehicle_model->getall_vehicle();
		$this->template->template_render('vehicle_solde',$data);
	}	
	
	public function addvehicle()
	{
		$data['v_group'] = $this->vehicle_model->get_vehiclegroup();
		$data['carte_peage'] = $this->vehicle_model->get_cartepeage();
//		$data['carte_peage'] = $this->fuel_carte_peage_model->getall_fuel_carte_peage();
