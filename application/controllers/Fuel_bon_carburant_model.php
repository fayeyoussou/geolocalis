...
$dataCompteur_bon_carburant_payments = array(
   'cpt_id' => '' ,
   'cpt_numero' => '1' 
);

return $this->db->insert('fuel_carte_carburant_recharge_payments', $dataCompteur_bon_carburant_payments);		
...
/*	
	public function get_numerocarburant_payments() { 
