...
//		$data['vehiclelist'] = $this->vehicle_model->getall_vehicle();
	...
	public function details()
	{
		...
		if(isset($incomexpensedetails[0]['ie_id'])) {
			//echo "bonjour";exit;
			//$customerdetails = $this->customer_model->get_customerdetails($incomexpensedetails[0]['t_customer_id']);
			//$driverdetails = $this->drivers_model->get_driverdetails($incomexpensedetails[0]['t_driver']);
			$data['paymentdetails'] = $this->facture_model->get_paymentdetails($incomexpensedetails[0]['t_id']);

/* debut */
			//$data['conteneurdetails'] = $this->facture_model->get_conteneurdetails($incomexpensedetails[0]['t_id']);
...
/*Fin*/     
            ...
            //$vehicleselect = $this->facture_model->get_vehicleselect($incomexpensedetails[0]);

           // $data['compagniedetails'] = $this->facture_model->get_compagnieselect();
          //  $compagnieselect = $this->facture_model->get_compagnieselect($incomexpensedetails[0]);
           ...
           // $vehicle_remorqueselect = $this->facture_model->get_vehicle_remorqueselect($incomexpensedetails[0]);
           ...
           // $zoneselect = $this->facture_model->get_zoneselect($incomexpensedetails[0]['t_id']);       
           ...
           // $zoneselect = $this->facture_model->get_articleselect($incomexpensedetails[0]['t_id']); // $data['zonedetails'] = $this->facture_model->get_articleselect($incomexpensedetails[0]['t_id']);            
          ...
          //  $type_tache_manutentionselect = $this->facture_model->get_type_tache_manutentionselect($incomexpensedetails[0]['t_id']);            
          ...
          //  $natureselect = $this->facture_model->get_natureselect($incomexpensedetails[0]['t_id']);
