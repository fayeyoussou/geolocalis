...
else
{
   ...
   // $co_type_conteneur='40_pieds';
    ...
    unset($addfactureconteneur['co_id']);
	$addconteneur = array('co_trip_id'=>$facture_id,'co_type_conteneur'=>$co_type_conteneur,'co_montant'=>$montant_conteneur,'co_description'=>$co_description,'co_type_conteneur'=>$co_type_conteneur,'co_zone'=>$co_zone,'co_adresse_livraison'=>$co_adresse_livraison,'co_numero_conteneur'=>$co_numero_conteneur);   //,'co_created_date'=>date('Y-m-d')     
