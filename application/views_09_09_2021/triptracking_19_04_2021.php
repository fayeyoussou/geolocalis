...
<body class="hold-transition ">
    ...
    <nav class="navbar navbar-expand navbar-light">
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
             <span class="nav-link"><b>De :</b> <?= $tripdetails['t_trip_fromlocation'] ?></span>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <span class="nav-link"><b>à : </b><?= $tripdetails['t_trip_tolocation'] ?></span>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <span class="nav-link"><b>N° véchicule : </b><?= $tripdetails['t_vechicle_details']->v_registration_no ?></span>
        </li>
         <li class="nav-item d-none d-sm-inline-block">
          <span class="nav-link"><b>Conducteur : </b><?= (isset($tripdetails['t_driver_details']->d_name))?$tripdetails['t_driver_details']->d_name:'<span class="badge badge-danger">Yet to Assign</span>'; ?></span>
        </li>
      </ul>
