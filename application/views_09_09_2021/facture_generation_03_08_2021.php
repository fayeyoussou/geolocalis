          ...
          <table class="table" >
            ...
            <tr>
             <th style="width:60%"> <h3>Total HT:</h3></th>
              ...
              <td><?php //$montantHT=$montanttotal+$montantags; //$facturedetails['t_trip_amount'] ?>  <b><h3><?= $montantHTAfficher = number_format($montantHT, 0, ',', ' '); ?></h3></b><?//= output($data['s_price_prefix']).$facturedetails['t_trip_amount'] ?></td>
            </tr> 
<?php if($facturedetails['t_taxe']=='avec_tva'){?>              
<tr>
              <th style="width:60%"><h3>Taxe 18%:</h3></th>
              <td><?php //$montantTVA=($montantHT*18)/100; //$facturedetails['t_trip_amount'] ?>  <b><h3><?= $montantTVAAfficher = number_format($montantTVA, 0, ',', ' '); ?></h3></b>
