...
<?php }?>              
            <tr><? $montantTTC=0 ?>
              ...
              <td><b><? $montantTTC=$montantTVA+$montantHT;        
                  //$montantTTClettre=0;
                  //$montantTTC=12345600; 
...
/*$this->load->library('email'); //Cheikh Diop TTD1 6872;              
$this->load->library('flavors/chocolate');
$this->email->some_function();  */
              
              
$val = $this->load->library('convertNumbersIntoWords');
//echo "ee=".$val = 123456701;//exit;
//echo "eeval=".$val;exit;
//echo $this->convertNumbersIntoWords->convert_number($val);
echo $this->convertNumbersIntoWords->convert_number($val);
?>              
