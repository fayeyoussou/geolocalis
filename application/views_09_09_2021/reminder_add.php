        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url(); ?>/dashboard">Rappel</a></li>
              <li class="breadcrumb-item active"><?php echo (isset($reminderdetails))?'Modifier rappel':'Ajouter rappel' ?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
 ...
 <div class="col-sm-6 col-md-offset-2 ">
    ...
    <div class="card-body">
                  ...
                  <button type="submit" class="btn btn-primary"> <?php echo (isset($reminderdetails))?'Modifier Rappel':'Ajouter Rappel' ?></button>
                 </div>
