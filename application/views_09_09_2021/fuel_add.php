    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?php echo (isset($fueldetails))?'Modifier du carburant':'Ajouter du carburant' ?>
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url(); ?>/dashboard">Carburant</a></li>
              <li class="breadcrumb-item active"><?php echo (isset($fueldetails))?'Modifier du carburant':'Ajouter du carburant' ?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
                  ...
                  <div class="form-group">
                   ...
                   <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         ...
                         <input type="text" required="true" class="form-control datepicker" id="v_fuelfilldate" name="v_fuelfilldate" value="<?php echo (isset($fueldetails)) ? $fueldetails[0]['v_fuelfilldate']:'' ?>" placeholder="Date de remplissage">
                    ...
                    <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         ...
                         <input type="text" class="form-control" id="v_fuel_quantity" name="v_fuel_quantity" value="<?php echo (isset($fueldetails)) ? $fueldetails[0]['v_fuel_quantity']:'' ?>" placeholder="Quantité">
                    ...
                    <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         ...
                         <input type="text" class="form-control" id="v_odometerreading" name="v_odometerreading" value="<?php echo (isset($fueldetails)) ? $fueldetails[0]['v_odometerreading']:'' ?>" placeholder="Numéro du kilometrage">
                    ...
                    <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         <label class="form-label">Montant<span class="form-required">*</span></label>
                          <input type="text" class="form-control" id="v_fuelprice" value="<?php echo (isset($fueldetails)) ? $fueldetails[0]['v_fuelprice']:'' ?>" name="v_fuelprice" placeholder="Montant">
                      </div>
                    </div>
                     ...
                     <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                       <label class="form-label">Commentaire</label>
                          <input type="text" class="form-control" id="v_fuelcomments" value="<?php echo (isset($fueldetails)) ? $fueldetails[0]['v_fuelcomments']:'' ?>" name="v_fuelcomments" placeholder="Commentaire sur le carburant">
                      </div>
                    </div>
      ...
      <div class="modal-footer">
                  ...
                  <button type="submit" class="btn btn-primary"> <?php echo (isset($fueldetails))?'Modifier carburant':'Ajouter carburant' ?></button>
      </div>
    </form>
             </div>
    </section>
