               ...
               <table id="custtbl" class="table card-table table-vcenter text-nowrap">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td><?php //echo output($vehicle_remorquelists['vr_type']); ?><span class="badge <?php echo ($vehicle_remorquelists['vr_type']=='20') ? 'badge-success' : 'badge-danger'; ?> "><?php echo ($vehicle_remorquelists['vr_type']=='20') ? '20 Pieds' : '40 Pieds'; ?></span> </td>
