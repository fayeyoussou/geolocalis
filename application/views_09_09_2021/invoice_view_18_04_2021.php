    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">invoice Details
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center"><?= ucwords($invoicedetails['i_num_facture']); ?></h3>

                <p class="text-muted text-center"><?= ucwords($invoicedetails['v_type']); ?></p>

                <p class="text-muted text-center"><?= ($invoicedetails['i_nature']==1)?'<span class="right badge badge-success">Active</span>':'<span class="right badge badge-danger">Inactive</span>' ?></p>
                ...
                <div class="tab-content">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><?= output($invoicedetails['i_nom_navire']) ?></td>
                    </tr>
                    <tr>
                      <td>Name</td>
                      <td><?= output($invoicedetails['i_num_facture']) ?></td>
                    </tr>
                    <tr>
                      <td>Model</td>
                      <td><?= output($invoicedetails['i_reference']) ?></td>
                    </tr>
                    <tr>
                      <td>Chassis No.</td>
                      <td><?= output($invoicedetails['i_nature']) ?></td>
                    </tr>
                    <tr>
                      <td>Engine No.</td>
                      <td><?= output($invoicedetails['v_engine_no']) ?></td>
                    </tr>
                    <tr>
                      <td>Manufactured By</td>
                      <td><?= output($invoicedetails['v_manufactured_by']) ?></td>
                    </tr>
                     <tr>
                      <td>Type</td>
                      <td><?= output($invoicedetails['v_type']) ?></td>
                    </tr>
                     <tr>
                      <td>Mileage/Litre</td>
                      <td><?= output($invoicedetails['v_mileageperlitre']) ?></td>
                    </tr>
                     <tr>
                      <td>API URL</td>
                      <td><?= output($invoicedetails['v_api_url']) ?></td>
                    </tr>
                     <tr>
                      <td>GPS API Username</td>
                      <td><?= output($invoicedetails['v_api_username']) ?></td>
                    </tr>
                     <tr>
                      <td>GPS API Password</td>
                      <td><?= output($invoicedetails['v_api_password']) ?></td>
                    </tr>
                     <tr>
                      <td>Created Date</td>
                      <td><?= output($invoicedetails['v_created_date']) ?></td>
                    </tr>
                     <tr>
                      <td>Modified Date</td>
                      <td><?= output($invoicedetails['v_modified_date']) ?></td>
                    </tr>
                  </tbody>
                </table>
                <div class="col-sm-3">
                  <a href="<?= base_url(); ?>invoice/editinvoice/<?= $invoicedetails['i_id']; ?>">
