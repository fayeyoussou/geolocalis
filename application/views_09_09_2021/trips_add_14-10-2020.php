			...
			<div class="col-sm-6 col-md-3">
                  ...
                  <div class="form-group">
                     <select id="t_remorque"  class="form-control selectized" required="true" name="t_remorque">
                        <option value="">Selectionner remorque</option>
...
<!-- DEBUT-->
               ...
               <div class="col-sm-6 col-md-3">
				...
				<div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($tripdetails)) ? $tripdetails[0]['t_date_pregate']:'' ?>" name="t_date_pregate" value="" class="form-control datepicker" placeholder="Date line">
                  </div>
               </div>
			...
			<div class="col-sm-6 col-md-3">
                  ...
                  <div class="form-group">
                     <select id="t_fuel_num_carte"  class="form-control selectized" required="true" name="t_fuel_num_carte">
                        <option value="">Selectionner une Carte carburant</option>
                        <?php foreach ($fuel_carte_rechargelist as $key => $fuel_carte_rechargelist) { ?>
                        <option <?php if((isset($tripdetails)) && $tripdetails[0]['t_fuel_num_carte'] == $fuel_carte_rechargelist['cr_id']){ echo 'selected';} ?> value="<?php echo output($fuel_carte_rechargelist['cr_id']) ?>"><?php echo output($fuel_carte_rechargelist['cr_name']) ?></option>
                        <?php  } ?>
                     </select>
                  </div>
               </div>
			   ...
			   <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label">Montant remplissage<span class="form-required">*</span></label>
                     <input type="text" value="<?php echo (isset($tripdetails)) ? $tripdetails[0]['t_fuel_montant']:'' ?>" name="t_fuel_montant" value="" class="form-control" placeholder="Montant remplissage">
                  </div>
               </div>				
			...
			<div class="col-sm-6 col-md-3">
                  ...
                  <div class="form-group">
                     <select id="t_destination"  class="form-control selectized" required="true" name="t_destination">
                        <option value="">Selectionner la destination</option>
                        <?php foreach ($vehicle_destinationlist as $key => $vehicle_destinationlist) { ?>
                        <option <?php if((isset($tripdetails)) && $tripdetails[0]['t_destination'] == vehicle_destinationlist['gr_id']){ echo 'selected';} ?> value="<?php echo output($vehicle_destinationlist['d_id']) ?>"><?php echo output($vehicle_destinationlist['d_name']) ?></option>
                        <?php  } ?>
                     </select>
                  </div>
               </div>				
