...
<!--Fin ajout remorque-->				   
			 ...
			 <!-- debut facture-->
            <?php if(userpermission('lr_factures_list') || userpermission('lr_factures_add')) { ?>
            <li class="nav-item has-treeview <?php echo ((activate_menu('factures'))=='active') ? 'menu-open':'' ?>
               <?php echo ((activate_menu('addfactures'))=='active') ? 'menu-open':'' ?><?php echo ((activate_menu('editfacture'))=='active') ? 'menu-open':'' ?>">
               <a href="#" class="nav-link <?php echo activate_menu('factures');?> <?php echo activate_menu('addfactures');?><?php echo activate_menu('editfactures');?>">
               ...
               <ul class="nav nav-treeview">
                  <?php if(userpermission('lr_factures_list')) { ?>
                  <li class="nav-item">
                     <a href="<?= base_url(); ?>factures" class="nav-link <?php echo activate_menu('factures');?><?php echo activate_menu('editfactures');?>">
                        <i class="nav-icon fas faa-list"></i>
                        <p>Liste des factures</p>
                     </a>
                  </li>
                  <?php //} if(userpermission('lr_factures_add')) { ?>
                  <li class="nav-item">
                     <a href="<?= base_url(); ?>factures/addfacture" class="nav-link <?php echo activate_menu('addfactures');?>">
                        <i class="nav-icon fas faa-plus"></i>
                        <p>Ajouter facture</p>
                     </a>
                  </li>
