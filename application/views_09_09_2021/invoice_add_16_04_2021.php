    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?php echo (isset($vehicledetails))?'Modifier facture':'Ajouter facture' ?>
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url(); ?>/dashboard">Tableau de bord</a></li>
              <li class="breadcrumb-item active"><?php echo (isset($vehicledetails))?'Modifier facture':'Ajouter facture' ?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<!---->                    <div class="col-sm-6 col-md-4">
                     ...
                     <!--<div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        ...
                        <select id="v_type" name="v_type" class="form-control " required="">
                         <option value="">Selectionner Type de facture</option> 
                    ...
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        <label for="v_color" class="form-label">Couleur du facture<small> (À afficher sur la carte)</small></label>
                    ...
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        ...
                        <select id="v_is_active" name="v_is_active" class="form-control " required="">
                          <option value="">Selectionner le statut du facture </option> 
                  ...
                  <!--<div class="col-sm-6 col-md-4">
                   ...
                   <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        <label for="v_group" class="form-label">Type de facture</label>
