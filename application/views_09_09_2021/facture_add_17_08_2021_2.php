    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?php echo (isset($facturedetails))?'Modifier la facture':'Ajouter facture' ?><?php if((isset($facturedetails))){ ?>    N°  <?php echo (isset($facturedetails)) ? $facturedetails[0]['t_num_facture']:'' ?>  <?php }else{?> N°
                FA000<?= $numerofacture; }?>  
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<!--<h2 class="m-0 text-dark">transport</h2> -->
                          <form method="post" id="facture_add_transport" class="card"  action="<?php echo base_url();?>facture/<?php echo (isset($facturedetails))?'updatefacture':'insertfacture'; ?>">
            <div class="row">
...
<?php if((isset($facturedetails))){}else{ ?>
          <input type="hidden" id="t_num_facture" name="t_num_facture" value="FA000<?= $numerofacture; ?>">
...
<div class="post">
                      <div class="user-block">
<!--exportation-->
                          <form method="post" id="facture_add_exportation" class="card"  action="<?php echo base_url();?>facture/<?php echo (isset($facturedetails))?'updatefacture':'insertfacture'; ?>">
...
<div class="post">
                      <div class="user-block">
                          ...
                          <form method="post" id="facture_add_transfert" class="card"  action="<?php echo base_url();?>facture/<?php echo (isset($facturedetails))?'updatefacture':'insertfacture'; ?>">
            <div class="row">
               <input type="hidden" name="t_id" id="t_id" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_id']:'' ?>" >
...
<div class="post">
                      <div class="user-block">
immobilisation
                          <form method="post" id="facture_add_immobilisation" class="card"  action="<?php echo base_url();?>facture/<?php echo (isset($facturedetails))?'updatefacture':'insertfacture'; ?>">
            <div class="row">
               <input type="hidden" name="t_id" id="t_id" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_id']:'' ?>" >
...
<!-- debut Nature transfert-->
                ...
                <div class="col-sm-6 col-md-3">
                 <div class="form-group">
                     ...
                     <select name="t_nature_transfert" id="t_nature_transfert" required="true" class="form-control">
...
<div class="post">
                      <div class="user-block">
                          ...
                          <form method="post" id="facture_add_manutentation" class="card"  action="<?php echo base_url();?>facture/<?php echo (isset($facturedetails))?'updatefacture':'insertfacture'; ?>">
            <div class="row">
               <input type="hidden" name="t_id" id="t_id" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_id']:'' ?>" >
                  ...
                  <div class="tab-pane" id="detention">
                    <div class="post">
                      <div class="user-block">
                          ...
                          <form method="post" id="facture_add_detention" class="card"  action="<?php echo base_url();?>facture/<?php echo (isset($facturedetails))?'updatefacture':'insertfacture'; ?>">
            <div class="row">
               <input type="hidden" name="t_id" id="t_id" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_id']:'' ?>" >
