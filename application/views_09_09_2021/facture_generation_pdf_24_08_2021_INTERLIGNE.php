...
$tbl = '<table width="350" border="1" >
    ...
    <tr>
        ...
        <td width="10">:</td>
        <td width="250">'.$customerdetails['c_name'].'</td>
        <td width="130"><b>TELEPHONE</b></td>
        <td width="10">:</td>
        <td width="150">'.$customerdetails['c_mobile'].'</td>
    </tr>

    <tr>
        <td width="130"><b>ADRESSE</b></td>
        <td width="10">:</td>
        <td  width="250">'.$customerdetails['c_address'].'</td>
        <td width="130"><b>E-MAIL </b></td>
        <td width="10">:</td>
        <td width="150">'.$customerdetails['c_email'].'</td>
...
$html = '<table border="0" cellspacing="0" align="center" width="100%" border="1"> 
