         ...
         <div class="container">
            ...
            <div class="col-md-2" style="padding:0;">
               <?php if(isset($this->session->userdata['session_data_fr']['c_name'])) { ?>
                  <div class="signin_up">
                  <ul>
                     <li>Bienvenue , <?= ucfirst($this->session->userdata['session_data_fr']['c_name']); ?> </li><br>
                     <li><a href="<?php echo base_url(); ?>frontendbooking/mybookings">Mes voyages</a>  <span style="color:#f0a2a3;">/</span></li>
                     <li><a href="<?php echo base_url(); ?>frontendbooking/logout">Deconnexion</a></li>
                  </ul>
               </div>
               <?php  } else { ?>
               <div class="signin_up">
                  <ul>
                     <li><a href="#myModals" data-toggle="modal" data-target="#myModals">Se connecter</a>  <span style="color:#f0a2a3;">/</span></li>
                     <li><a href="#myModal" data-toggle="modal" data-target="#myModal">S'inscrire</a></li>
                  </ul>
               </div>
            <?php  } ?>
            </div>
         ...
         <div class="modal-dialog">
            ...
            <form id="login" method="post" class="basicvalidation" action="<?php echo base_url();?>frontendbooking/login">
               <div class="login-block">
                  ...
                  <button  type="submit" value="Login" style="position: relative;">S'identifier</button>
                  <br>
                  ...
                  <div class="sign_in"><a  data-dismiss="modal" href="#myModal" data-toggle="modal" data-target="#myModal">S'inscrire</a></div>
               </div>
            </form>
         </div>
      </div>
         ...
         <div class="modal-dialog">
            ...
            <form id="signup" method="post" class="basicvalidation" action="<?php echo base_url();?>frontendbooking/signup">
               <div class="login-block">
                  ...
                  <br>
                  <span class="terms_tb">En vous inscrivant, vous acceptez notre <a class="cond_tb" href="#">Termes et conditions.</a></span> <br>
                  <br>
                  <button  type="submit" value="Sign up" style="position: relative;">S'inscrire</button>
                  <br>
                 
                  <div class="signup_res" style="text-align:center;"></div>
                  <br>
                  <div class="account"><a data-dismiss="modal" href="#myModals"data-toggle="modal" data-target="#myModals">Vous avez déjà un compte?</a></div>
                  <div class="sign_in"><a data-dismiss="modal" href="#myModals"data-toggle="modal" data-target="#myModals">Se connecter</a></div>
               </div>
            </form>
         </div>
      </div>
         ...
         <div class="modal-dialog">
            ...
            <form id="forgot" data-parsley-validate="">
               <div class="login-block">
                  ...
                  <br>
                  <div class="account"><a href="#">Vous avez déjà un compte?</a></div>
                  <div class="sign_in"><a data-dismiss="modal" href="#myModals"data-toggle="modal" data-target="#myModals">Se connecter</a></div>
               </div>
            </form>
         </div>
                  ...
                  <section id="Search" class="LB XXCN  P20">
                     ...
                     <div class="searchRow clearfix">
                        <div class="LB">
                           ...
                           <input id="t_trip_fromlocation" name="t_trip_fromlocation" class="XXinput searching" placeholder="De" type="text" tabindex="1" required/>
                        </div>
                        <span class="switchButton" id="switchButton"></span>
                        <div class="searchRight NoPaddingRight">
                           <label class="inputLabel">à</label>
                           <input id="t_trip_tolocation" name="t_trip_tolocation" class="XXinput searching" placeholder="à" type="text" tabindex="2" required />
                        </div>
                     </div>
                    <div class="searchRow clearfix">
                        <div class="LB" style="margin-top: 0px;">
                           <label class="inputLabel">Type de véhicule</label>
                             <select style="height: 32px; margin-top: -1px;" required id="t_vechicle"  class="XXinput searching"  name="t_vechicle">
                            <option value="">Selectionnez le véhicule</option>
                     ...
                     <button type="submit" class="RB Xbutton">Réservé maintenant</button>
                  </section>
               </form>
            </div>
            <div class="col-md-6">
