      ...
      <nav class="mt-2">
         <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview <?php echo ((activate_menu('invoice'))=='active') ? 'menu-open':'' ?>
               <?php echo ((activate_menu('addinvoice'))=='active') ? 'menu-open':'' ?> <?php echo ((activate_menu('viewinvoice'))=='active') ? 'menu-open':'' ?><?php echo ((activate_menu('editinvoice'))=='active') ? 'menu-open':'' ?><?php echo ((activate_menu('invoicegroup'))=='active') ? 'menu-open':'' ?>">
               <a href="#" class="nav-link <?php echo activate_menu('invoice');?> <?php echo activate_menu('addinvoice');?><?php echo activate_menu('viewinvoice');?><?php echo activate_menu('editinvoice');?><?php echo activate_menu('invoicegroup');?>">
               ...
               <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                     <a href="<?= base_url(); ?>invoice" class="nav-link <?php echo activate_menu('invoice');?><?php echo activate_menu('editinvoice');?><?php echo activate_menu('viewinvoice');?>">
                 ...
                 <?php } if(userpermission('lr_vech_add')) { ?>
                  <li class="nav-item">
                     <a href="<?= base_url(); ?>invoice/addinvoice" class="nav-link <?php echo activate_menu('addinvoice');?>">
