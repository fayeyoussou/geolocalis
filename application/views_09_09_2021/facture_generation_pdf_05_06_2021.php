...
if($conteneurdetails['co_type_conteneur']!='') {
  ...
  $html .= '<br>
            ...
            <td width="120">'.$facturedetails['t_type_facturation'].'</td>
            <td width="130">'.$conteneurdetails['co_numero_conteneur'].'</td>
            <td width="50">'.$type.'</td>
            <td width="170">'.$destination.' - '.$conteneurdetails['co_adresse_livraison'].'</td>
            <td width="80">'.$montant_conteneurAffiche.'</td>
            </tr>';
}
