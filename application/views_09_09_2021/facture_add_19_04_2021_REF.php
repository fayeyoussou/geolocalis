    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?php echo (isset($facturedetails))?'Edit Booking':'Add Booking' ?>
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url(); ?>/dashboard">Vehicle</a></li>
              <li class="breadcrumb-item active"><?php echo (isset($facturedetails))?'Edit Booking':'Add Booking' ?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
       ...
       <form method="post" id="facture_add" class="card"  action="<?php echo base_url();?>facture/<?php echo (isset($facturedetails))?'updatefacture':'insertfacture'; ?>">
         <div class="card-body">
            <div class="row">
               ...
               <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label">facture End Location<span class="form-required">*</span></label>
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_trip_tolocation']:'' ?>" name="t_trip_tolocation" id="t_trip_tolocation" class="form-control" placeholder="facture End Location">
                  </div>
               </div>
               <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label">Approx Total KM<span class="form-required">*</span></label>
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_totaldistance']:'' ?>" readonly="true" name="t_totaldistance" id="t_totaldistance" class="form-control" placeholder="Approx Total KM">
                  </div>
               </div>
               <div class="col-sm-6 col-md-3">
                  <div class="form-group">
               ...
               <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label">facture End Date<span class="form-required">*</span></label>
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_end_date']:'' ?>" name="t_end_date" value="" class="form-control datepicker" placeholder="facture End Date">
                  </div>
               </div>
                <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label">Total Amount<span class="form-required">*</span></label>
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['t_trip_amount']:'' ?>" name="t_trip_amount" value="" class="form-control" placeholder="Total Amount">
                  </div>
               </div>
               
               <div class="col-sm-6 col-md-3">
                 <div class="form-group">
                     <label class="form-label">facture Status</label>
                     <select name="t_trip_status" id="t_trip_status" required="true" class="form-control">
                      <option value="">facture Status</option>
                      <option <?php if((isset($facturedetails)) && $facturedetails[0]['t_trip_status'] =='yettostart'){ echo 'selected';} ?> value="yettostart">Yet to start</option>
                      <option <?php if((isset($facturedetails)) && $facturedetails[0]['t_trip_status'] == 'completed'){ echo 'selected';} ?> value="completed">Completed</option>
                      <option <?php if((isset($facturedetails)) && $facturedetails[0]['t_trip_status'] =='ongoing'){ echo 'selected';} ?> value="ongoing">Ongoing</option>
                      <option <?php if((isset($facturedetails)) && $facturedetails[0]['t_trip_status'] =='cancelled'){ echo 'selected';} ?> value="cancelled">Cancelled</option>
                    </select>
                  </div>
                </div>
           ...
           <?php } ?>
            ...
            <div class="card-footer text-right">
               <button type="submit" class="btn btn-primary"> <?php echo (isset($facturedetails))?'Update facture':'Add facture' ?></button>
            </div>
      </form>
             </div>
    </section>
