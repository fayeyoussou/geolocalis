        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12 col-md-12 col-lg-8 order-2 order-md-1">
              <div class="row">
                ...
                <div class="col-12 col-sm-4">
                  <div class="info-box bg-light">
                    <div class="info-box-content">
                      <span class="info-box-text text-center text-muted"><?= ($invoicedetails['t_invoice_amount'] > $totalpaidamt)?'Pending':'Excess' ?></span>
                  ...
                  <h4>Overview:</h4>
                    <div class="post">
                      ...
                      <div class="user-block">
                        ...
                        <span class="description"><?= $invoicedetails['t_start_date']; ?></span>
                      </div>
                    </div> to
                     <div class="col-lg-5">
                      <div class="user-block">
                        ...
                        <span class="description"><?= $invoicedetails['t_end_date']; ?></span>
                      </div>
                       </div>
            ...
            <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
              <div class="mt-2 mb-3">
                <a href="#" class="btn btn-sm btn-success <?= ($invoicedetails['t_invoice_amount'] - $totalpaidamt==0)?'disabled':'' ?>" data-toggle="modal" data-target="#modal-AddPayment">Add Payment</a>
                <a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#modal-invoiceexpense">invoice Expense</a>
                <a href="<?= base_url(); ?>invoice/invoice/<?= $invoicedetails['t_id']; ?>" target="_blank" class="btn btn-sm btn-success" >Generate Invoice</a>
              </div> 
              <br>
              <div class="text-muted">
                ...
                <p><div class="col-6"><a href="<?= base_url() ?>invoice/sendtracking?email=<?= urlencode($customerdetails['c_email']); ?>&trackingcode=<?= $invoicedetails['t_trackingcode'] ?>&t_id=<?= $invoicedetails['t_id'] ?>" class="btn btn-sm btn-success">Share to Customer</a></div></p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="invoicepayments" action="<?= base_url() ?>invoice/invoicepayment" method="post">
                <div class="card-body">
                 ...
                 <input type="hidden" class="form-control" value="<?= $invoicedetails['t_vechicle']; ?>" name="tp_i_id" id="tp_i_id" placeholder="tp_i_id">
...
<div class="modal fade show" id="modal-invoiceexpense" aria-modal="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Add invoice Expense</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
      <div class="modal-body">
        <form class="form-horizontal" id="addinvoiceexpense" action="<?= base_url() ?>invoice/addinvoiceexpense" method="post">
                <div class="card-body">
                 ...
                 <input type="hidden" class="form-control" value="<?= $invoicedetails['t_vechicle']; ?>" name="ie_i_id" id="ie_i_id">
