    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="card-body"> 
                  ...
                  <div class="row">
                   <input type="hidden" name="tra_id" id="tra_id" value="<?php echo (isset($transitairedetails)) ? $transitairedetails[0]['t_id']:'' ?>" >
                    ...
                    <div class="col-sm-6 col-md-6">
                      <div class="form-group">
                       <label class="form-label">Adresse<span class="form-required">*</span></label>
                        <textarea class="form-control" id="tra_address" autocomplete="off" placeholder="Address"  name="tra_address"><?php echo (isset($transitairedetails)) ? $transitairedetails[0]['t_address']:'' ?></textarea>
                      </div>
                    </div>
