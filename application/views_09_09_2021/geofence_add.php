...
<div style="display: none" id="color-palette"></div>
	<div class="row">
              <div class="col-sm-4 col-md-4">
                <h3 class="card-title">
                  <div class="form-group row">
                    <label for="geo_description" class="col-sm-5 col-form-label">Choisessez l'adresse </label>
                    <div class="form-group col-sm-7">
                      <input id="pac-input" class="form-control" type="text" placeholder="Entrer l'adresse">
                    </div>
                  </div>
              ...
              <div class="form-group col-sm-4 col-md-3">
               <button class="btn btn-block btn-outline-danger btn-sm" id="delete-button">Supprimer la selection</button>
              </div>
              <!-- /.col -->
              <div class="form-group col-sm-4 col-md-3">
                <button class="btn btn-block btn-outline-success btn-sm" id="showgeofencemodel">Enregistrer</button>
              </div>
                 </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Enregistrer la sélection de géorepérages</h4>
              ...
              <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="form-group col-sm-8">
                      <input type="text" class="form-control" name="geo_name" id="geo_name" required="true" placeholder="Nom géorepérage">
                    </div>
                  </div>
                 <div class="form-group row">
                    <label for="geo_description" class="col-sm-4 col-form-label">Description</label>
                    <div class="form-group col-sm-8">
                      <input type="text" class="form-control" name="geo_description" id="geo_description" required="true" placeholder="Description géorepérage">
                    </div>
                  </div>
                   <div class="form-group row">
                    <label for="Cateogry" class="col-sm-4 col-form-label">Véhicule</label>
                    <div class="form-group col-sm-8">
