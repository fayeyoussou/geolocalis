<div class="content-header">
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6">
            <h1 class="m-0 text-dark">Rapport des revenus et dépenses
            </h1>
         </div>
         <!-- /.col -->
         <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               ...
               <li class="breadcrumb-item active">Rapport des revenus et dépenses</li>
            </ol>
         </div>
         <!-- /.col -->
      </div>
            ...
            <div class="row">
               <div class="col-md-3">
                  <div class="form-group row">
                     <label for="incomeexpense_from" class="col-sm-5 col-form-label">Rapport de</label>
               ...
               <div class="col-md-3">
                  <div class="form-group row">
                     <label for="incomeexpense_to" class="col-sm-5 col-form-label">Rapport à</label>
                     <div class="col-sm-6 form-group">
        ...
        <div class="card-body p-0">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Totale dépense</span>
