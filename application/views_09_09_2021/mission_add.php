    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?php echo (isset($missiondetails))?'Modifier mission':'Ajouter mission' ?>
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="card-body">
           ...
           <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <select id="mi_conteneur"  class="form-control"  name="mi_conteneur" >
       ...
       <?php //if((isset($facturedetails))){ ?> 
            ...
            <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <select id="mi_driver"  class="form-control"  name="mi_driver">
                       <option value="">Selectionner chauffeur</option>
                        <?php  foreach ($driverlist as $key => $driverlists) { ?>
                        <option <?php if((isset($facturedetails)) && $facturedetails[0]['mi_driver'] == $driverlists['d_id']){ echo 'selected';} ?> value="<?php echo output($driverlists['d_id']) ?>"><?php echo output($driverlists['d_name']); ?></option>
                        <?php  } ?>
                     </select>
                  </div>
               </div>
...
<!-- Debut Carte Carburant--> 
               ...
               <div class="col-sm-6 col-md-3">
                   <div class="form-group">
                     ...
                     <select id="mi_carte_carburant"  class="form-control"  name="mi_carte_carburant">
                       <option value="">Selectionner la Carte carburant</option>
                        <?php  foreach ($carte_carburantlist as $key => $carte_carburantlists) { ?>
                        <option <?php if((isset($facturedetails)) && $facturedetails[0]['mi_carte_carburant'] == $carte_carburantlists['cc_id']){ echo 'selected';} ?> value="<?php echo output($carte_carburantlists['cc_id']) ?>"><?php echo output($carte_carburantlists['cc_name']).' - '. output($carte_carburantlists['cc_numero']);  ?> </option>
                        <?php  } ?>
                     </select>
                  </div>
              </div>
            ...
            <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['mi_carte_carburant_amount']:'' ?>" name="mi_carte_carburant_amount" id="mi_carte_carburant_amount" class="form-control" placeholder="Montant carburant">
                  </div>
               </div>                
...
<!--            <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php //echo (isset($facturedetails)) ? $facturedetails[0]['mi_carte_carburant_quantite']:'' ?>" name="mi_carte_carburant_quantite" id="mi_carte_carburant_quantite" class="form-control" placeholder="Montant carburant">
                  </div>
               </div>-->
...
<!-- Debut Carte Carburant--> 
               ...
               <div class="col-sm-6 col-md-3">
                   <div class="form-group">
                     ...
                     <select id="mi_carte_peage"  class="form-control"  name="mi_carte_peage">
                       <option value="">Selectionner la Carte carburant</option>
                        <?php  foreach ($carte_peagelist as $key => $carte_peagelists) { ?>
                        <option <?php if((isset($facturedetails)) && $facturedetails[0]['mi_carte_peage'] == $carte_peagelists['cp_id']){ echo 'selected';} ?> value="<?php echo output($carte_peagelists['cp_id']) ?>"><?php echo output($carte_peagelists['cp_name']).' - '. output($carte_peagelists['cp_numero']);  ?> </option>
                        <?php  } ?>
                     </select>
                  </div>
              </div>
                ...
                <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['mi_carte_peage_amount']:'' ?>" name="mi_carte_peage_amount" id="mi_carte_peage_amount" class="form-control" placeholder="Montant péage">
                  </div>
               </div>                
...
<!-- Fin Carte Carburant-->                    
                 ...
                 <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['mi_frais_ags']:'' ?>" name="mi_frais_ags" id="mi_frais_ags" class="form-control" placeholder="Frais AGS ">
                  </div>
               </div> 
                ...
                <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['mi_autre_frais']:'' ?>" name="mi_autre_frais" id="mi_autre_frais" class="form-control" placeholder="Autres Frais">
                  </div>
               </div>                       
            ...
            <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <select id="mi_vehicle"  class="form-control"  name="mi_vehicle" >
                        <option value="">Sélectionner Véhicule</option>
                        <?php  foreach ($vechiclelist as $key => $vechiclelists) { ?>
                        <option <?php if((isset($facturedetails)) && $facturedetails[0]['mi_vehicle'] == $vechiclelists['v_id']){ echo 'selected';} ?> value="<?php echo output($vechiclelists['v_id']) ?>"><?php echo output($vechiclelists['v_name']).' - '. output($vechiclelists['v_registration_no']); ?></option>
                        <?php  } ?>
                     </select>
                  </div>
               </div>                
            ...
            <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <select id="mi_vehicle_remorque"  class="form-control"  name="mi_vehicle_remorque" >
                        ...
                        <option <?php if((isset($facturedetails)) && $facturedetails[0]['mi_vehicle_remorque'] == $vehicleremorquelists['vr_id']){ echo 'selected';} ?> value="<?php echo output($vehicleremorquelists['vr_id']) ?>"><?php echo output($vehicleremorquelists['vr_name']).' - '. output($vehicleremorquelists['vr_numero_immatriculation']); ?></option>
                        <?php  } ?>
                     </select>
                  </div>
               </div>
   ...
   -->                
                ...
                <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['mi_date_depart']:'' ?>" name="mi_date_depart" value="" class="form-control datepicker" placeholder="Date départ">
                  </div>
               </div>                
                <!-- FIN Date line--> 
                ...
                <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($facturedetails)) ? $facturedetails[0]['mi_date_retour']:'' ?>" name="mi_date_retour" value="" class="form-control datepicker" placeholder="Date retour">
                  </div>
               </div>                
                <!-- FIN Date line-->                 
