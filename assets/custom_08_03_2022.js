 ...
 "use strict";
  $.validator.setDefaults({
   ...
   // $('#add_driver,#vehicle_add,#invoice_add,#customer_add,#login,#trip_add,#Income_Expense,#fuel,#track,#geofencesave,#trippayments,.basicvalidation,#smtpconfigtestemail').validate({
    ...
    $('#facture_add,#facture_add_transport,#facture_add_exportation,#facture_add_transfert,#facture_add_immobilisation,#facture_add_manutentation,#facture_add_detention,#fuel_carte_peage_add,#fuel_carte_carburant_add,#vehicle_remorque_add,#transitaire_add,#add_driver,#vehicle_add,#invoice_add,#customer_add,#login,#trip_add,#Income_Expense,#fuel,#track,#geofencesave,#trippayments,.basicvalidation,#smtpconfigtestemail,#zone_add').validate({
