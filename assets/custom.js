 ...
 "use strict";
  $.validator.setDefaults({
   ...
   // $('#add_driver,#vehicle_add,#invoice_add,#customer_add,#login,#trip_add,#Income_Expense,#fuel,#track,#geofencesave,#trippayments,.basicvalidation,#smtpconfigtestemail').validate({
    ...
    $('#conteneur_export,#facture_add,#facture_add_transport,#facture_add_exportation,#facture_add_transfert,#facture_add_immobilisation,#facture_add_manutentation,#facture_add_detention,#fuel_carte_peage_add,#fuel_carte_carburant_add,#vehicle_remorque_add,#transitaire_add,#add_driver,#vehicle_add,#invoice_add,#customer_add,#login,#trip_add,#Income_Expense,#fuel,#track,#geofencesave,#trippayments,#addfactureconteneur_import,.basicvalidation,#smtpconfigtestemail,#zone_add,#export').validate({
...
/*            co_numero_conteneur:{
        ...
        messages: {
             co_numero_conteneur: {
                required: "Numéro de conteneur est obligatoire",
            },
			v_type: {
            ...
            ie_amount:{
             ...
             ie_amount:{
                required: "Amount is required",
                lessThanEqual : "Le montant saisi doit être inferieur au montant restant"
            },
			co_type_conteneur:{
                required: "Amount is required",
             //   lessThanEqual : "Amount must be less than pending amount"
    ...
    $("#v_registration_no").on('keypress change', function(event) {
       ...
       $("#v_api_username").val(data);
        ...
        $('#vehiclelisttbl,#invoicelisttbl,#driverslisttbl,#facturetbl,#triptbl,#custtbl,#fueltbl,#incomexpensetbl,#conteneurtbl').DataTable({
           "bLengthChange": true,
           "bInfo": false,
           "ordering": true
        });
