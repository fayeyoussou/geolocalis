  ...
  var CardWidget = function ($) {
    ...
    function () {
      ...
      _proto._init = function _init(card) {
        ...
        this._parent = card;
          $(this).find(this._settings.collapseTrigger).on('click', function(){
          _this3.toggle();
        });
          $(this).find(this._settings.maximizeTrigger).on('click', function(){
          _this3.toggleMaximize();
        });
          $(this).find(this._settings.removeTrigger).on('click', function(){
          _this3.remove();
        });
      } // Static
      ;
