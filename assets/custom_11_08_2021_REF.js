 ...
 "use strict";
  $.validator.setDefaults({
   ...
   // $('#add_driver,#vehicle_add,#invoice_add,#customer_add,#login,#trip_add,#Income_Expense,#fuel,#track,#geofencesave,#trippayments,.basicvalidation,#smtpconfigtestemail').validate({
    ...
    $('#fuel_carte_peage_add,#fuel_carte_carburant_add,#vehicle_remorque_add,#facture_add,#transitaire_add,#add_driver,#vehicle_add,#invoice_add,#customer_add,#login,#trip_add,#Income_Expense,#fuel,#track,#geofencesave,#trippayments,.basicvalidation,#smtpconfigtestemail').validate({
    ...
    $("#v_registration_no").on('keypress change', function(event) {
       ...
       $("#v_api_username").val(data);
        ...
        $('#vehiclelisttbl,#invoicelisttbl,#driverslisttbl,#facturetbl,#triptbl,#custtbl,#fueltbl,#incomexpensetbl').DataTable({
           "bLengthChange": true,
           "bInfo": false,
           "ordering": true
        });
